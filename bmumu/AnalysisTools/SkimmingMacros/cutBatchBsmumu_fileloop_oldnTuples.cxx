...
//
//oldnTuples version runs as was done on Feb 24 notes, over the v6 2019 nTuples
...
void loopFiles(TString indir, TString filter=""){
  ...
  TString outdir("/eos/home-a/agrummer/BsmumuData/FinalSkim/v6");//2020/v1 includes updated z0 err (approx. to derivation)
...
// cout<< "Entries in original tree: "<< ts->GetEntries() <<endl;
  ...
  double B_minChi2MuonsIPtoAnyPV;
  float closeTrkDOCA, closeTrkDCA, closeTrkZCA, B_iso_7_Chi2_5_LoosePt05, Bsmumu_minLogChi2ToAnyPV_PV_MIN_Z0_BA;
  ...
  */
  ...
  TBranch* b3 = tf->Branch("closeTrkDOCA",&closeTrkDOCA,"closeTrkDOCA/F");
