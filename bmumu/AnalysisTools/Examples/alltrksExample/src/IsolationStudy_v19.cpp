...
//
//
//v_18 is for the 2020 ntuples... add the DOCA variables:
//  Close track variables ( 5x5= 25)
// 2)_T0000000035_LooSiHi1Pt05_corc2cnt        —-> partial run2
// 2)_T0004194304_LooSiHi1Pt05_corc2cnt      —-> custom TVA, with simple approximation method as the ntuplemaker          (I believe its equivalent to what you have been looking at so far)
// 2)_T0134217728_LooSiHi1Pt05_f2dc2           —-> custom TVA, with trk perigee, and 2x2 covariance for logChi2 calculation  (the proposed replacement for the above)
// 2)_T0008388608_LooSiHi1Pt05_corc2cnt      —-> loose TVA, with simple approximation method as the ntuplemaker              (I believe its equivalent to what you have been looking at so far)
// 2)_T0008388608_LooSiHi1Pt05_f2dc2           —-> loose TVA         (the proposed replacement for the above)
// closeTrkDCA
// closeTrkDCAErr
// closeTrkZCA
// closeTrkZCAErr
...
//
//and make 
// DOCA_LooSiHi1Pt05_corc2cnt
// DOCA_LooSiHi1Pt05_corc2cnt
// DOCA_LooSiHi1Pt05_f2dc2
// DOCA_LooSiHi1Pt05_corc2cnt
// DOCA_LooSiHi1Pt05_f2dc2
//
//version 19 includes a common event selection tool - only event numbers that are in both the new
// and the old nTuple versions are considered
//
////change to new nTuples v2 for indir
//
////March 11, updated the closeTrkDOCA variable fill info - created closeTrkDOCA_3, and closeTrkDOCA_comp
...
void IsolationStudy_fileloop(TString myYear){
  ...
  TString indir("");
  TString AllPath("");
  TString nTupleVer("new"); //actually old will not work with current output folders anyway
  // TString indir("");
  TString indir1(""); 
  indir1 = "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v3/";
  // if (myYear.Contains("MC")){
  //       indir1 = "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v2/";}
  // else{ indir1 = "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v1/";}
  ...
  if (myYear.EqualTo("2017")){
        ...
        // AllPath = indir + "2017All/";
        AllPath = indir1 + "2017Allcommon/";
        ...
        // AllPath = indir + "2018All/";
        AllPath = indir1 + "2018Allcommon/";
      ...
      //       indir =  indir + "2016/";}
        ...
        // AllPath = indir + "2016mainAll/";
        AllPath = indir1 + "2016mainAllcommon/";
  }else if (myYear.EqualTo("2016_2")){
        // indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v6/2016/";
        indir = indir + "2016main303846/";
        // AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v6/2016All/";
        AllPath = indir1 + "2016main303846All/";
        ...
        // AllPath = indir + "MC16aAll/";
        AllPath = indir1 + "MC16aAllcommon/";
        ...
        indir = indir + "MC16d/";
        // AllPath = indir + "MC16dAll/";
        AllPath = indir1 + "MC16dAllcommon/";
        ...
        // AllPath = indir + "MC16eAll/";
        AllPath = indir1 + "MC16eAllcommon/";
  }
...
Int_t totalTracks(0);
  if (dpdf != NULL){
    while (entry = readdir(dpdf)){
      ...
      std::cout << "# of candidates: "<<  ts->GetEntries() << std::endl;
        ...
        float closeTrkDOCA_comp(0.);
        float closeTrkDOCA_LooSiHi1Pt05_corc2cnt(0.);
        float closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom(0.);
        float closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom(0.);        
        float closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose(0.);
        float closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose(0.);
        ...
        TBranch *Branch_closeTrkDOCA_comp = tUpdate->Branch("closeTrkDOCA_comp",&closeTrkDOCA_comp,"closeTrkDOCA_comp/F");
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_corc2cnt = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_corc2cnt",&closeTrkDOCA_LooSiHi1Pt05_corc2cnt,"closeTrkDOCA_LooSiHi1Pt05_corc2cnt/F");
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom",&closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom,"closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom/F");
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom",&closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom,"closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom/F");
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose",&closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose,"closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose/F");
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose",&closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose,"closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose/F");
  ...
  //variables added for 2020 nTuples:
    float closeTrkDCA_T0000000035_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkZCA_T0000000035_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkDCA_T0004194304_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkZCA_T0004194304_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkDCA_T0134217728_LooSiHi1Pt05_f2dc2(0.);
    float closeTrkZCA_T0134217728_LooSiHi1Pt05_f2dc2(0.);
    float closeTrkDCA_T0008388608_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkZCA_T0008388608_LooSiHi1Pt05_corc2cnt(0.);
    float closeTrkDCA_T0008388608_LooSiHi1Pt05_f2dc2(0.);
    float closeTrkZCA_T0008388608_LooSiHi1Pt05_f2dc2(0.);
  ...
  // ts->SetBranchAddress("closeTrkDOCA",&closeTrkDOCA);                      //
  // TMath::Sqrt(pow(closeTrkDCA,2)+pow(closeTrkZCA,2))
  //variables added for 2020 nTuples:
  ts->SetBranchAddress("closeTrkDCA_T0000000035_LooSiHi1Pt05_corc2cnt",&closeTrkDCA_T0000000035_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0000000035_LooSiHi1Pt05_corc2cnt",&closeTrkZCA_T0000000035_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkZCA variable
  ts->SetBranchAddress("closeTrkDCA_T0004194304_LooSiHi1Pt05_corc2cnt",&closeTrkDCA_T0004194304_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0004194304_LooSiHi1Pt05_corc2cnt",&closeTrkZCA_T0004194304_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkZCA variable
  ts->SetBranchAddress("closeTrkDCA_T0134217728_LooSiHi1Pt05_f2dc2",&closeTrkDCA_T0134217728_LooSiHi1Pt05_f2dc2);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0134217728_LooSiHi1Pt05_f2dc2",&closeTrkZCA_T0134217728_LooSiHi1Pt05_f2dc2);                      // DxAOD closeTrkZCA variable
  ts->SetBranchAddress("closeTrkDCA_T0008388608_LooSiHi1Pt05_corc2cnt",&closeTrkDCA_T0008388608_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0008388608_LooSiHi1Pt05_corc2cnt",&closeTrkZCA_T0008388608_LooSiHi1Pt05_corc2cnt);                      // DxAOD closeTrkZCA variable
  ts->SetBranchAddress("closeTrkDCA_T0008388608_LooSiHi1Pt05_f2dc2",&closeTrkDCA_T0008388608_LooSiHi1Pt05_f2dc2);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0008388608_LooSiHi1Pt05_f2dc2",&closeTrkZCA_T0008388608_LooSiHi1Pt05_f2dc2);                      // DxAOD closeTrkZCA variable
...
int main(int argc, char* argv[])
{
  TString Dataset, nTupleVersion;
  if (argc>1) Dataset = TString(argv[1]);
  // if (argc>2) nTupleVersion = TString(argv[2]);
