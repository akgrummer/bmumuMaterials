...
//
//v8 includes the intersect set
// remove the run number condition
...
void RunOverData(TString inYear ="", TString inTTVA="", TString nTupleVer = ""){
    ...
    myC->SaveAs(myDir+"data/"+inYear+"_"+inTTVA+"chi2_2020Mar3_Intersect_"+nTupleVer+"_noRN.root");
    // myC->SaveAs(myDir+"figures/"+inYear+"_"+inTTVA+"chi2_2019Jun12.png");
    myC->SaveAs(myDir+"figures/"+inYear+"_"+inTTVA+"chi2_2020Mar3_Intersect_"+nTupleVer+"_noRN.png");
...
void RunOverSavedFiles_Chi2(TString theYear="", TString Association="", TString TTVA = ""){
    ...
    TFile* ifile_chi2_loose_new = new TFile(myDir+theYear+"_loosechi2_2020Mar3_Intersect_new_noRN.root");
    ...
    TFile* ifile_chi2_loose_old = new TFile(myDir+theYear+"_loosechi2_2020Mar3_Intersect_old_noRN.root");
    ...
    TFile* ifile_chi2_custom_new = new TFile(myDir+theYear+"_customchi2_2020Mar3_Intersect_new_noRN.root");
    ...
    TFile* ifile_chi2_custom_old = new TFile(myDir+theYear+"_customchi2_2020Mar3_Intersect_old_noRN.root");
...
//tight label doesn't matter here as long as the line colors don't change
    ...
    allC->SaveAs("/eos/home-a/agrummer/www/bmumu/AnalysisTools/Examples/alltrksExample/figures/Chi2intersect/"+theYear+Association+"_"+TTVA+"_combo_2020Mar3_Intersect.png");
