...
TCanvas* IsolationStudy_fileloop(TString myYear="", TString TTVA = ""){
  ...
  dpdf = opendir(finpath.Data());
    ...
    h_chi2_VTX_otherPV   = new TH1F("h_chi2_VTX_otherPV","chi2 to ass. B vertex for all tracks",200,-5,15);
    h_chi2_PV_otherPV    = new TH1F("h_chi2_PV_otherPV","chi2 to associated PV for selected tracks",200,-5,15);
    h_chi2_VTX_assPV   = new TH1F("h_chi2_VTX_assPV","chi2 to ass. B vertex for all tracks",200,-5,15);
    h_chi2_PV_assPV    = new TH1F("h_chi2_PV_assPV","chi2 to associated PV for selected tracks",200,-5,15);
    h_chi2_VTX_nonAss   = new TH1F("h_chi2_VTX_nonAss","chi2 to ass. B vertex for all tracks",200,-5,15);
    h_chi2_PV_nonAss    = new TH1F("h_chi2_PV_nonAss","chi2 to associated PV for selected tracks",200,-5,15);
    h_chi2_VTX_all   = new TH1F("h_chi2_VTX_all","chi2 to ass. B vertex for all tracks",200,-5,15);
    h_chi2_PV_all    = new TH1F("h_chi2_PV_all","chi2 to associated PV for selected tracks",200,-5,15);
              ...
              if (TTVA.EqualTo("loose")){ 
                 //associated to B PVs
                  if ( (*idtrk_pvidx_loose).at(idx) == B_PV_idx){
                      if (h_chi2_VTX_assPV) h_chi2_VTX_assPV->Fill( (*B_VTX_trksChi2).at(idx) );
                      if (h_chi2_PV_assPV) h_chi2_PV_assPV->Fill( (*B_PV_trksChi2).at(idx) );
                  }
                  ...
                  {   
                      if (h_chi2_VTX_otherPV) h_chi2_VTX_otherPV->Fill( (*B_VTX_trksChi2).at(idx) );
                      if (h_chi2_PV_otherPV) h_chi2_PV_otherPV->Fill( (*B_PV_trksChi2).at(idx) );
                  }
                  //non-associated
                  if ( (*idtrk_pvidx_loose).at(idx) == pv_type->size()-1 ) // or choose tracks ass. to other real PV's (for non-ass. tracks use '==' instead)
                  {   
                      if (h_chi2_VTX_nonAss) h_chi2_VTX_nonAss->Fill( (*B_VTX_trksChi2).at(idx) );
                      if (h_chi2_PV_nonAss) h_chi2_PV_nonAss->Fill( (*B_PV_trksChi2).at(idx) );
                  }
              }
...
void RunOverSavedFiles_Chi2(TString theYear="", TString Association=""){
    SetAtlasStyle();
    ...
    TH1F *h_chi2_PV_otherPV_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_PV_otherPV");
    // h_chi2_PV_otherPV_loose->Scale(1./(h_chi2_PV_otherPV_loose->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_PV_nonAss");
    // h_chi2_PV_nonAss_loose->Scale(1./(h_chi2_PV_nonAss_loose->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_PV_assPV");
    ...
    TH1F *h_chi2_PV_otherPV_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_PV_otherPV");
    // h_chi2_PV_otherPV_nominal->Scale(1./(h_chi2_PV_otherPV_nominal->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_PV_nonAss");
    // h_chi2_PV_nonAss_nominal->Scale(1./(h_chi2_PV_nonAss_nominal->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_PV_assPV");
    // h_chi2_PV_assPV_nominal->Scale(1./(h_chi2_PV_assPV_nominal->Integral(0, numberOfBinsChi2 + 1)));
...
////
    ...
    TH1F *h_chi2_PV_otherPV_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_PV_otherPV");
    // h_chi2_PV_otherPV_tight->Scale(1./(h_chi2_PV_otherPV_tight->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_PV_nonAss");
    // h_chi2_PV_nonAss_tight->Scale(1./(h_chi2_PV_nonAss_tight->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_PV_assPV");
    // h_chi2_PV_assPV_tight->Scale(1./(h_chi2_PV_assPV_tight->Integral(0, numberOfBinsChi2 + 1)));
    ...
    h_chi2_PV_otherPV_loose->SetLineColor(kBlue); 
    h_chi2_PV_otherPV_loose->SetMarkerSize(0.);
    h_chi2_PV_nonAss_loose->SetLineColor(kBlue); 
    h_chi2_PV_nonAss_loose->SetMarkerSize(0.);
    h_chi2_PV_assPV_loose->SetLineColor(kBlue); 
    h_chi2_PV_assPV_loose->SetMarkerSize(0.);
    h_chi2_PV_otherPV_nominal->SetLineColor(kRed); 
    h_chi2_PV_otherPV_nominal->SetMarkerSize(0.);
    h_chi2_PV_nonAss_nominal->SetLineColor(kRed); 
    h_chi2_PV_nonAss_nominal->SetMarkerSize(0.);
    h_chi2_PV_assPV_nominal->SetLineColor(kRed); 
    h_chi2_PV_assPV_nominal->SetMarkerSize(0.);
    h_chi2_PV_otherPV_tight->SetLineColor(kGreen+2); 
    h_chi2_PV_otherPV_tight->SetMarkerSize(0.);
    h_chi2_PV_nonAss_tight->SetLineColor(kGreen+2); 
    h_chi2_PV_nonAss_tight->SetMarkerSize(0.);
    h_chi2_PV_assPV_tight->SetLineColor(kGreen+2); 
    h_chi2_PV_assPV_tight->SetMarkerSize(0.);
...
if(Association.EqualTo("otherPV")){
    if (h_chi2_PV_otherPV_loose) h_chi2_PV_otherPV_loose->GetXaxis()->SetLimits(-15,15);
    if (h_chi2_PV_otherPV_loose) h_chi2_PV_otherPV_loose->Draw("e0 hist");
    if (h_chi2_PV_otherPV_nominal) h_chi2_PV_otherPV_nominal->Draw("e0 hist same");
    if (h_chi2_PV_otherPV_tight) h_chi2_PV_otherPV_tight->Draw("e0 hist same");
    h_chi2_PV_otherPV_loose->GetXaxis()->SetTitle("#chi^{2}");
    h_chi2_PV_otherPV_loose->GetYaxis()->SetTitle("Candidates * Num. of Trks per cand.");
    legAll = new TLegend(0.5, 0.2, 0.6, 0.35);
}
if(Association.EqualTo("nonAss")){
     if (h_chi2_PV_nonAss_loose) h_chi2_PV_nonAss_loose->GetXaxis()->SetLimits(-15,15);
    if (h_chi2_PV_nonAss_loose) h_chi2_PV_nonAss_loose->Draw("e0 hist");
    if (h_chi2_PV_nonAss_nominal) h_chi2_PV_nonAss_nominal->Draw("e0 hist same");
    if (h_chi2_PV_nonAss_tight) h_chi2_PV_nonAss_tight->Draw("e0 hist same");
    h_chi2_PV_nonAss_loose->GetXaxis()->SetTitle("#chi^{2}");
    h_chi2_PV_nonAss_loose->GetYaxis()->SetTitle("Candidates * Num. of Trks per cand.");
    legAll = new TLegend(0.2, 0.75, 0.3, 0.9);
}    
if(Association.EqualTo("assPV")){
    if (h_chi2_PV_assPV_loose) h_chi2_PV_assPV_loose->GetXaxis()->SetLimits(-15,15);
    if (h_chi2_PV_assPV_loose) h_chi2_PV_assPV_loose->Draw("e0 hist");
    if (h_chi2_PV_assPV_nominal) h_chi2_PV_assPV_nominal->Draw("e0 hist same");
    if (h_chi2_PV_assPV_tight) h_chi2_PV_assPV_tight->Draw("e0 hist same");
    h_chi2_PV_assPV_loose->GetXaxis()->SetTitle("#chi^{2}");
    h_chi2_PV_assPV_loose->GetYaxis()->SetTitle("Candidates * Num. of Trks per cand.");
    legAll = new TLegend(0.2, 0.2, 0.3, 0.35);
}
