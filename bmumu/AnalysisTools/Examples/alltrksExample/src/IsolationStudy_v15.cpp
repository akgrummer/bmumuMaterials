...
//v15
//new ntuples
//include a variable idtrk_pvidx_custom made with minimum chi2 tool
//renamed:
...
void IsolationStudy_fileloop(TString myYear){
  ...
  if (myYear.EqualTo("2017")){
        ...
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2017/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2017All/";
        ...
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2018/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2018All/";
  }else if (myYear.EqualTo("2016")){
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2016/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/2016All/";
  }else if (myYear.EqualTo("MC16a")){
        // indir = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LastSkim_2019Mar27/MC16a/";
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16a/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16aAll/";
  }else if (myYear.EqualTo("MC16d")){
        // indir = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LastSkim_2019Mar27/MC16d/";
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16d/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16dAll/";
  }else if (myYear.EqualTo("MC16e")){
        // indir = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LastSkim_2019Mar27/MC16e/";
        indir = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16e/";
        AllPath = "/eos/home-a/agrummer/BsmumuData/FinalSkim/v4/MC16eAll/";
  }
  ...
  if (dpdf != NULL){
    while (entry = readdir(dpdf)){
      ...
      std::cout << "# of candidates: "<<  ts->GetEntries() << std::endl;
        ...
        newfname.Append("_2019July30.root");//custom, dR<1.0 for iso, doca>2 set to2
        ...
        Double_t B_Iso_TTVA_custom(0.);
        Double_t B_Iso_TTVA_custom_dr(0.);
        int B_Iso_Ntracks_TTVA_custom(0);
        int closeTrkNtrks_TTVA_custom_c1 (0);
        int closeTrkNtrks_TTVA_custom_c2 (0);
        float closeTrkDOCA_TTVA_custom_c7(0.);
        float closeTrkDOCA_TTVA_custom_c2(0.);
...
//initialize branches:
        TBranch *Branch_B_Iso_TTVA_custom = tUpdate->Branch("B_Iso_TTVA_custom", &B_Iso_TTVA_custom, "B_Iso_TTVA_custom/D");
        TBranch *Branch_B_Iso_TTVA_custom_dr = tUpdate->Branch("B_Iso_TTVA_custom_dr", &B_Iso_TTVA_custom_dr, "B_Iso_TTVA_custom_dr/D");
        TBranch *Branch_B_Iso_Ntracks_TTVA_custom = tUpdate->Branch("B_Iso_Ntracks_TTVA_custom", &B_Iso_Ntracks_TTVA_custom, "B_Iso_Ntracks_TTVA_custom/I");
        TBranch *Branch_closeTrkNtrks_TTVA_custom_c1 = tUpdate->Branch("closeTrkNtrks_TTVA_custom_c1", &closeTrkNtrks_TTVA_custom_c1, "closeTrkNtrks_TTVA_custom_c1/I");
        ...
        TBranch *Branch_closeTrkDOCA_TTVA_custom_c2 = tUpdate->Branch("closeTrkDOCA_TTVA_custom_c2", &closeTrkDOCA_TTVA_custom_c2, "closeTrkDOCA_TTVA_custom_c2/F");
  ...
  TVector3 myTrkVec;
    ...
    int nclosetrks_TTVA_custom_c1 (0);
    int nclosetrks_TTVA_custom_c2 (0);
    float docamin_TTVA_custom_c7(0.);
    float docamin_TTVA_custom_c2(0.);
    ...
    if (myTrkVec.Pt()>500.
        ...
        if ( (*idtrk_pvidx_custom).at(idx) == B_PV_idx){
                ...
                // if (myTrkVec.DeltaR(myBVec) < 1.0){
                    tracksPt_TTVA_custom_c2 += myTrkVec.Pt();
                    tracksCnt_TTVA_custom_c2+=1;
                }
            // }
        //B Iso tuned DR<1.0:
            //B PV associated tracks
            ...
            // for DOCA and NcloseTracks
                if ((*B_VTX_trksChi2).at(idx) <=7.0) {
                    if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_TTVA_custom_c7) {
                        docamin_TTVA_custom_c7 = (*closeTrkDOCA_alltrks).at(idx);
                    }
                    if ( (*B_VTX_trksChi2).at(idx) <=2.0) {
                        //NcloseTracks
                        nclosetrks_TTVA_custom_c2++;
                        if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_TTVA_custom_c2) {
                            docamin_TTVA_custom_c2 = (*closeTrkDOCA_alltrks).at(idx);
                        }
                        if ((*B_VTX_trksChi2).at(idx)<=1.0) nclosetrks_TTVA_custom_c1++;
                    } 
                }
            }
            // All tracks
            ...
            B_Iso_TTVA_custom = B_pT/(B_pT + tracksPt_TTVA_custom_c2);
            B_Iso_TTVA_custom_dr = B_pT/(B_pT + tracksPt_TTVA_custom_dr);
            B_Iso_Ntracks_TTVA_custom = tracksCnt_TTVA_custom_c2;
            closeTrkNtrks_TTVA_custom_c1 = nclosetrks_TTVA_custom_c1;
            ...
            if (docamin_TTVA_custom_c2 > 3.) docamin_TTVA_custom_c2 = 3.;
            closeTrkDOCA_TTVA_custom_c2 = docamin_TTVA_custom_c2;
            ...
            if (docamin_all_c7 > 3.) docamin_all_c7 = 3.;
            closeTrkDOCA_all_c7 = docamin_all_c7;
            if (docamin_all_c2 > 3.) docamin_all_c2 = 3.;
