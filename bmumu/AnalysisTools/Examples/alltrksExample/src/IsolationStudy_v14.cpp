  ...
  if (dpdf != NULL){
    while (entry = readdir(dpdf)){
      ...
      std::cout << "# of candidates: "<<  ts->GetEntries() << std::endl;
        ...
        Double_t B_Iso_TTVA_tight_c2(0.);
        int B_Iso_Ntracks_TTVA_tight_c2(0);
        int closeTrkNtrks_TTVA_tight_c1 (0);
        int closeTrkNtrks_TTVA_tight_c2 (0);
        float closeTrkDOCA_TTVA_tight_c7(0.);
        float closeTrkDOCA_TTVA_tight_c2(0.);
        Double_t B_Iso_all_c5(0.);
        int B_Iso_Ntracks_all_c5(0);
        Double_t B_Iso_all_c6(0.);
        int B_Iso_Ntracks_all_c6(0);
        int closeTrkNtrks_all_c1(0);
        int closeTrkNtrks_all_c2(0);
        float closeTrkDOCA_all_c7(0.);
        float closeTrkDOCA_all_c2(0.);
//initialize branches:
        TBranch *Branch_B_Iso_TTVA_tight_c2 = tUpdate->Branch("B_Iso_TTVA_tight_c2", &B_Iso_TTVA_tight_c2, "B_Iso_TTVA_tight_c2/D");
        TBranch *Branch_B_Iso_Ntracks_TTVA_tight_c2 = tUpdate->Branch("B_Iso_Ntracks_TTVA_tight_c2", &B_Iso_Ntracks_TTVA_tight_c2, "B_Iso_Ntracks_TTVA_tight_c2/I");
        TBranch *Branch_closeTrkNtrks_TTVA_tight_c1 = tUpdate->Branch("closeTrkNtrks_TTVA_tight_c1", &closeTrkNtrks_TTVA_tight_c1, "closeTrkNtrks_TTVA_tight_c1/I");
        TBranch *Branch_closeTrkNtrks_TTVA_tight_c2 = tUpdate->Branch("closeTrkNtrks_TTVA_tight_c2", &closeTrkNtrks_TTVA_tight_c2, "closeTrkNtrks_TTVA_tight_c2/I");
        TBranch *Branch_closeTrkDOCA_TTVA_tight_c7 = tUpdate->Branch("closeTrkDOCA_TTVA_tight_c7", &closeTrkDOCA_TTVA_tight_c7, "closeTrkDOCA_TTVA_tight_c7/F");
        TBranch *Branch_closeTrkDOCA_TTVA_tight_c2 = tUpdate->Branch("closeTrkDOCA_TTVA_tight_c2", &closeTrkDOCA_TTVA_tight_c2, "closeTrkDOCA_TTVA_tight_c2/F");
        TBranch *Branch_B_Iso_all_c5 = tUpdate->Branch("B_Iso_all_c5", &B_Iso_all_c5, "B_Iso_all_c5/D");
        TBranch *Branch_B_Iso_Ntracks_all_c5 = tUpdate->Branch("B_Iso_Ntracks_all_c5", &B_Iso_Ntracks_all_c5, "B_Iso_Ntracks_all_c5/I");
        TBranch *Branch_B_Iso_all_c6 = tUpdate->Branch("B_Iso_all_c6", &B_Iso_all_c6, "B_Iso_all_c6/D");
        TBranch *Branch_B_Iso_Ntracks_all_c6 = tUpdate->Branch("B_Iso_Ntracks_all_c6", &B_Iso_Ntracks_all_c6, "B_Iso_Ntracks_all_c6/I");
        TBranch *Branch_closeTrkNtrks_all_c1 = tUpdate->Branch("closeTrkNtrks_all_c1", &closeTrkNtrks_all_c1, "closeTrkNtrks_all_c1/I");
        TBranch *Branch_closeTrkNtrks_all_c2 = tUpdate->Branch("closeTrkNtrks_all_c2", &closeTrkNtrks_all_c2, "closeTrkNtrks_all_c2/I");
        TBranch *Branch_closeTrkDOCA_all_c7 = tUpdate->Branch("closeTrkDOCA_all_c7", &closeTrkDOCA_all_c7, "closeTrkDOCA_all_c7/F");
        TBranch *Branch_closeTrkDOCA_all_c2 = tUpdate->Branch("closeTrkDOCA_all_c2", &closeTrkDOCA_all_c2, "closeTrkDOCA_all_c2/F");
  ...
  TVector3 myTrkVec;
    ...
    Double_t tracksPt_TTVA_tight_c2(0.);
    int tracksCnt_TTVA_tight_c2(0);
    int nclosetrks_TTVA_tight_c1 (0);
    int nclosetrks_TTVA_tight_c2 (0);
    float docamin_TTVA_tight_c7(0.);
    float docamin_TTVA_tight_c2(0.);
...
for (auto ievent=0; ievent<nevents; ievent++)
    {
        ...
        tracksPt_TTVA_tight_c2=0.;
        tracksCnt_TTVA_tight_c2=0;
        nclosetrks_TTVA_tight_c1 = 0;
        nclosetrks_TTVA_tight_c2 = 0;
        docamin_TTVA_tight_c7=999.0;
        docamin_TTVA_tight_c2=999.0;
        tracksPt_all_c5=0.;
        tracksCnt_all_c5=0;
        tracksPt_all_c6=0.;
        tracksCnt_all_c6=0;
    ...
    if (myTrkVec.Pt()>500.
        ...
        //B Iso tuned:
            ...
            if ( (*idtrk_pvidx_tight).at(idx) == pv_type->size()-1){
                if ( (*B_VTX_trksChi2).at(idx) <=2.0) {        
                    // if (myTrkVec.DeltaR(myBVec) < 0.7){
                    if (myTrkVec.DeltaR(myBVec) < 1.0){
                        tracksPt_TTVA_tight_c2 += myTrkVec.Pt();
                        tracksCnt_TTVA_tight_c2+=1;
                    }
                }
            }
            //B PV associated tracks
            else if ( (*idtrk_pvidx_tight).at(idx) == B_PV_idx){
                // if (myTrkVec.DeltaR(myBVec) < 0.7){
                if (myTrkVec.DeltaR(myBVec) < 1.0){
                    tracksPt_TTVA_tight_c2 += myTrkVec.Pt();
                    tracksCnt_TTVA_tight_c2+=1;
            ...
            // for DOCA and NcloseTracks
                if ((*B_VTX_trksChi2).at(idx) <=7.0) {
                    if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_TTVA_tight_c7) {
                        docamin_TTVA_tight_c7 = (*closeTrkDOCA_alltrks).at(idx);
                    }
                    if ( (*B_VTX_trksChi2).at(idx) <=2.0) {
                        //NcloseTracks
                        nclosetrks_TTVA_tight_c2++;
                        if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_TTVA_tight_c2) {
                            docamin_TTVA_tight_c2 = (*closeTrkDOCA_alltrks).at(idx);
                        }
                        if ((*B_VTX_trksChi2).at(idx)<=1.0) nclosetrks_TTVA_tight_c1++;
                    } 
                }
            }
            // All tracks
            ...
            if ( (*B_PV_trksChi2).at(idx) <=5.0
                  ...
                  && (myTrkVec.DeltaR(myBVec) < 1.0)){
                    tracksPt_all_c5 += myTrkVec.Pt();
                    tracksCnt_all_c5+=1;
            }
            if ( (*B_PV_trksChi2).at(idx) <=6.0
                  // && (myTrkVec.DeltaR(myBVec) < 0.7)) {
                  && (myTrkVec.DeltaR(myBVec) < 1.0)) {
                    tracksPt_all_c6 += myTrkVec.Pt();
                    tracksCnt_all_c6+=1;
            }
            // old association
            // for DOCA and NcloseTracks
            ...
            {
                if ((*B_VTX_trksChi2).at(idx)<=7.0) {
                    if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_all_c7) {
                        docamin_all_c7 = (*closeTrkDOCA_alltrks).at(idx);
                    }
                    if ( (*B_VTX_trksChi2).at(idx) <=2.0) {
                        nclosetrks_all_c2++;
                        if ( (*closeTrkDOCA_alltrks).at(idx) < docamin_all_c2) {
                            docamin_all_c2 = (*closeTrkDOCA_alltrks).at(idx);
                        }
                        if ((*B_VTX_trksChi2).at(idx)<=1.0) nclosetrks_all_c1++;
                    }
                }
            }
        }
            ...
            B_Iso_TTVA_tight_c2 = B_pT/(B_pT + tracksPt_TTVA_tight_c2);
            B_Iso_Ntracks_TTVA_tight_c2 = tracksCnt_TTVA_tight_c2;
            closeTrkNtrks_TTVA_tight_c1 = nclosetrks_TTVA_tight_c1;
            closeTrkNtrks_TTVA_tight_c2 = nclosetrks_TTVA_tight_c2;
            if (docamin_TTVA_tight_c7 == 999.) docamin_TTVA_tight_c7 = -0.01;
            closeTrkDOCA_TTVA_tight_c7 = docamin_TTVA_tight_c7;
            if (docamin_TTVA_tight_c2 == 999.) docamin_TTVA_tight_c2 = -0.01;
            closeTrkDOCA_TTVA_tight_c2 = docamin_TTVA_tight_c2;
            B_Iso_all_c5 = B_pT/(B_pT + tracksPt_all_c5);
            B_Iso_Ntracks_all_c5 = tracksCnt_all_c5;
            B_Iso_all_c6 = B_pT/(B_pT + tracksPt_all_c6);
            B_Iso_Ntracks_all_c6 = tracksCnt_all_c6;
            closeTrkNtrks_all_c1 = nclosetrks_all_c1;
            closeTrkNtrks_all_c2 = nclosetrks_all_c2;
            if (docamin_all_c7 == 999.) docamin_all_c7 = -0.01;
            closeTrkDOCA_all_c7 = docamin_all_c7;
            if (docamin_all_c2 == 999.) docamin_all_c2 = -0.01;
            closeTrkDOCA_all_c2 = docamin_all_c2;
