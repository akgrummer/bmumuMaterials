...
void ComparisonPlot(VariableInfo vexp, TString wt = "",
    ...
    // }
        // fin1p = p1 + ft + "/" + "*.root";
        fin1p = p1 + ft + "Allcommon/" + "LASTskim_"+DataType+"_All_2020Feb11.root";
    if(DataType.EqualTo("2016main")){
        fin2p = p2 + "2016" + "Allcommon/" + "LASTskim_2016_All_2019Dec5.root";
    }else{
        fin2p = p2 + ft + "Allcommon/" + "LASTskim_"+DataType+"_All_2019Dec5.root";
    }
    ...
    hist2 = RetrieveHist(fin2p, DataType, vexp, wt, 1, "all", "norm", h2s);
    // fin1->Close();
