...
// 2)_T0000000035_LooSiHi1Pt05_201516        —-> partial run2
...
void IsolationStudy_fileloop(TString myYear){
  ...
  if (myYear.EqualTo("2017")){
        ...
        AllPath = "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v1/MC16a303846All/";
...
Int_t totalTracks(0);
  if (dpdf != NULL){
    while (entry = readdir(dpdf)){
      ...
      std::cout << "# of candidates: "<<  ts->GetEntries() << std::endl;
        ...
        float closeTrkDOCA_LooSiHi1Pt05_201516(0.);
        ...
        TBranch *Branch_closeTrkDOCA_LooSiHi1Pt05_201516 = tUpdate->Branch("closeTrkDOCA_LooSiHi1Pt05_201516",&closeTrkDOCA_LooSiHi1Pt05_201516,"closeTrkDOCA_LooSiHi1Pt05_201516/F");
  ...
  //variables added for 2020 nTuples:
    float closeTrkDCA_T0000000035_LooSiHi1Pt05_201516(0.);
    float closeTrkZCA_T0000000035_LooSiHi1Pt05_201516(0.);
  ...
  //variables added for 2020 nTuples:
  ts->SetBranchAddress("closeTrkDCA_T0000000035_LooSiHi1Pt05_201516",&closeTrkDCA_T0000000035_LooSiHi1Pt05_201516);                      // DxAOD closeTrkDCA variable 
  ts->SetBranchAddress("closeTrkZCA_T0000000035_LooSiHi1Pt05_201516",&closeTrkZCA_T0000000035_LooSiHi1Pt05_201516);                      // DxAOD closeTrkZCA variable
...
for (auto ievent=0; ievent<nevents; ievent++)
    ...
    for (unsigned int idx=0; idx<ntrks; idx++) 
    {
        ...
        if (myTrkVec.Pt()>500. && myTrkVec.Eta()<2.5
            ...
            closeTrkDOCA_LooSiHi1Pt05_201516 = TMath::Sqrt(pow(closeTrkDCA_T0000000035_LooSiHi1Pt05_201516,2)+pow(closeTrkZCA_T0000000035_LooSiHi1Pt05_201516,2));
