...
void RunOverSavedFiles_Chi2(TString theYear="", TString Association=""){
    ...
    // TFile* ifile_chi2_loose = new TFile(myDir+theYear+"_loosechi2_2019Jun10.root");
...
//tight label doesn't matter here as long as the line colors don't change
    ...
    allC->SaveAs("/eos/home-a/agrummer/www/bmumu/AnalysisTools/Examples/alltrksExample/figures/Chi2/"+theYear+Association+"_2019Jun13.png");
}
