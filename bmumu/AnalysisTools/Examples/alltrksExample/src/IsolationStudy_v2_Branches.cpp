...
TString AllPath = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LastSkim_2019Mar27/2017All/";
TString NewFile = AllPath+"LASTskim_2017_All_testweight.root";
TFile *fFrame = new TFile(AllPath+"LASTskim_2017_All_testweight.root", "Frame");
TTree *tFrame = (TTree*)fFrame->Get("T_mv");
 TString newfname(NewFile);
newfname.Remove(newfname.Index(".root"),newfname.Length());
newfname.Append("_test.root");
