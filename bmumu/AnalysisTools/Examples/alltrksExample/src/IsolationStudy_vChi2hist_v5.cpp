...
for (auto ievent=0; ievent<nevents; ievent++)
    {
        ...
        if (Pileup.EqualTo("low")) {
            if (PRIVX_mu < 20 || PRIVX_mu > 30) continue;
        }else if(Pileup.EqualTo("medium")) {
            if (PRIVX_mu < 35 || PRIVX_mu > 45) continue;
        }else if(Pileup.EqualTo("high")) {
            if (PRIVX_mu < 45 || PRIVX_mu > 55) continue;
        }
...
void RunOverSavedFiles_Chi2(TString theYear="", TString Association="", TString Pileup=""){
    SetAtlasStyle();
    // TString Vertex = "PV";
    TString Vertex = "VTX";
    ...
    TFile* ifile_chi2_loose = new TFile(myDir+theYear+"_loose_"+Pileup+"_chi2_2019Jun19.root");
    ...
    TH1F *h_chi2_PV_otherPV_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_otherPV");
    // h_chi2_PV_otherPV_loose->Scale(1./(h_chi2_PV_otherPV_loose->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_nonAss");
    // h_chi2_PV_nonAss_loose->Scale(1./(h_chi2_PV_nonAss_loose->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_loose = (TH1F*)Canvas_chi2_loose->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_assPV");
    ...
    TFile* ifile_chi2_nominal = new TFile(myDir+theYear+"_nominal_"+Pileup+"_chi2_2019Jun19.root");
    TCanvas *Canvas_chi2_nominal = (TCanvas*)ifile_chi2_nominal->Get("trks chi2");
    
    TH1F *h_chi2_PV_otherPV_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_otherPV");
    // h_chi2_PV_otherPV_nominal->Scale(1./(h_chi2_PV_otherPV_nominal->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_nonAss");
    // h_chi2_PV_nonAss_nominal->Scale(1./(h_chi2_PV_nonAss_nominal->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_nominal = (TH1F*)Canvas_chi2_nominal->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_assPV");
...
////
    ...
    TFile* ifile_chi2_tight = new TFile(myDir+theYear+"_tight_"+Pileup+"_chi2_2019Jun19.root");
    TCanvas *Canvas_chi2_tight = (TCanvas*)ifile_chi2_tight->Get("trks chi2");
    
    TH1F *h_chi2_PV_otherPV_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_otherPV");
    // h_chi2_PV_otherPV_tight->Scale(1./(h_chi2_PV_otherPV_tight->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_nonAss_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_nonAss");
    // h_chi2_PV_nonAss_tight->Scale(1./(h_chi2_PV_nonAss_tight->Integral(0, numberOfBinsChi2 + 1)));
    TH1F *h_chi2_PV_assPV_tight = (TH1F*)Canvas_chi2_tight->GetListOfPrimitives()->FindObject("h_chi2_"+Vertex+"_assPV");
...
if(Association.EqualTo("otherPV")){
    ...
    h_chi2_PV_otherPV_loose->GetXaxis()->SetTitle(XaxisTitle);
...
if(Association.EqualTo("nonAss")){
    ...
    h_chi2_PV_nonAss_loose->GetXaxis()->SetTitle(XaxisTitle);
...
if(Association.EqualTo("assPV")){
    ...
    h_chi2_PV_assPV_loose->GetXaxis()->SetTitle(XaxisTitle);
    ...
    TString PileupText="";
        if (Pileup.EqualTo("low")) {
            PileupText = "20<PRIVX_{#mu}<30";
        }else if(Pileup.EqualTo("medium")) {
            PileupText = "35<PRIVX_{#mu}<45";
        }else if(Pileup.EqualTo("high")) {
            PileupText = "45<PRIVX_{#mu}<55";
        }
    TLatex texMessage;
    //     // texMessage = new TLatex(, , PileupText);
    ...
    texMessage.DrawLatexNDC(0.23, 0.67, PileupText);
