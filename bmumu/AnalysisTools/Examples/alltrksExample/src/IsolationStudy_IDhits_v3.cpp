...
void RunOverData(TString inYear ="", TString nTupleVer = ""){
    ...
    myC->SaveAs(myDir+"data/"+inYear+"_IDhits_2020Mar3"+nTupleVer+".root");
    myC->SaveAs(myDir+"figures/"+inYear+"_IDhits_2020Mar3"+nTupleVer+".png");
...
void RunOverSavedFiles_Chi2(TString theYear="", TString Detector=""){
    ...
    TFile* ifile_IDhits_new = new TFile(myDir+theYear+"_IDhits_2020Mar3new.root");
    ...
    TFile* ifile_IDhits_old = new TFile(myDir+theYear+"_IDhits_2020Mar3old.root");
...
//tight label doesn't matter here as long as the line colors don't change
    ...
    allC->SaveAs("/eos/home-a/agrummer/www/bmumu/AnalysisTools/Examples/alltrksExample/figures/IDhits/"+theYear+"_"+Detector+"_2020Mar3.png");
}
