...
// DOCA_LooSiHi1Pt05_f2dc2
//
// march 6, 2020 v18 is used again replacing v1 input to v2 indir:
//
//
...
void IsolationStudy_fileloop(TString myYear){
  ...
  if (myYear.EqualTo("2017")){
        ...
        // indir = "/eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/BsMuMuVal2020/final_MC/Bsmumu/v2/";
        indir = indir + "MC16d/";
        AllPath = indir1 + "MC16dAll/";
