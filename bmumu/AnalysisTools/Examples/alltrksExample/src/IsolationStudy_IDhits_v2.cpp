...
TCanvas* IsolationStudy_fileloop(TString myYear=""){
  SetAtlasStyle();
  cout<<"DEBUG 1"<<endl;
  cout<< myYear<<" "<< endl;
...
if(h_PIXhits_Run2) h_PIXhits_Run2->Draw("same");
...
void RunOverData(TString inYear =""){
    SetAtlasStyle();
    ...
    TCanvas* myC = IsolationStudy_fileloop(inYear);
    myC->GetListOfPrimitives()->Print();
    myC->SaveAs(myDir+"data/"+inYear+"_IDhits_2019Jun13.root");
    myC->SaveAs(myDir+"figures/"+inYear+"_IDhits_2019Jun13.png");
...
void RunOverSavedFiles_Chi2(TString theYear="", TString Detector=""){
    ...
    TFile* ifile_IDhits = new TFile(myDir+theYear+"_IDhits_2019Jun13.root");
    TCanvas *Canvas_IDhits = (TCanvas*)ifile_IDhits->Get("trks chi2");


    TH1F *h_PIXhits_Loose = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_PIXhits_Loose");
    TH1F *h_SCThits_Loose = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_SCThits_Loose");
    TH1F *h_IBLhits_Loose = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_IBLhits_Loose");
    TH1F *h_PIXhits_isTight = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_PIXhits_isTight");
    TH1F *h_SCThits_isTight = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_SCThits_isTight");
    TH1F *h_IBLhits_isTight = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_IBLhits_isTight");
    TH1F *h_PIXhits_Run1 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_PIXhits_Run1");
    TH1F *h_SCThits_Run1 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_SCThits_Run1");
    TH1F *h_IBLhits_Run1 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_IBLhits_Run1");
    TH1F *h_PIXhits_Run2 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_PIXhits_Run2");
    TH1F *h_SCThits_Run2 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_SCThits_Run2");
    TH1F *h_IBLhits_Run2 = (TH1F*)Canvas_IDhits->GetListOfPrimitives()->FindObject("h_IBLhits_Run2");
...
h_PIXhits_isTight->SetLineColor(kRed);
h_PIXhits_isTight->SetMarkerSize(0.);
h_SCThits_isTight->SetLineColor(kRed);
h_SCThits_isTight->SetMarkerSize(0.);
...
h_PIXhits_Run2->SetLineColor(kGreen+2);
h_PIXhits_Run2->SetMarkerSize(0.);
h_SCThits_Run2->SetLineColor(kGreen+2);
h_SCThits_Run2->SetMarkerSize(0.);
...
if(Detector.EqualTo("PIX")) {
    if (h_PIXhits_Loose) h_PIXhits_Loose->GetXaxis()->SetRangeUser(0, 16);
    ...
    if (h_PIXhits_Run2) h_PIXhits_Run2->Draw("e0 hist same");
    h_PIXhits_Loose->GetXaxis()->SetTitle("Num. of PIX Hits");
    h_PIXhits_Loose->GetYaxis()->SetTitle("Candidates #times Num. of Trks per cand.");
    legAll = new TLegend(0.62, 0.7, 0.8, 0.9);
}
if(Detector.EqualTo("SCT")) {
    if (h_SCThits_Loose) h_SCThits_Loose->GetXaxis()->SetRangeUser(0, 25);
    ...
    if (h_SCThits_Run2) h_SCThits_Run2->Draw("e0 hist same");
    h_SCThits_Loose->GetXaxis()->SetTitle("Num. of SCT Hits");
    h_SCThits_Loose->GetYaxis()->SetTitle("Candidates #times Num. of Trks per cand.");
    legAll = new TLegend(0.62, 0.7, 0.8, 0.9);
}   
...
//tight label doesn't matter here as long as the line colors don't change
        ...
        legAll->AddEntry(h_IBLhits_Run2, "Revised ID Selection (w/IBL)" ,"l");
