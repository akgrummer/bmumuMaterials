...
//run with: 
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_HighPileUp.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_MiddlePileUp.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_LowPileUp.root\")"

//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_HighPileUp.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_MiddlePileUp.root\")"
//root -l addClassBDT_2016.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_LowPileUp.root\")"
#include <cstdlib>
#include <vector>
#include <iostream>
#include <map>
...
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_HighPileUp.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_MiddlePileUp.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband/LASTskim.Data_2015HLTand2016HLTLxy_RightSideband_DOCAlt500_LowPileUp.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/www/bmumu/Data/LASTskim.MC16Bs_DOCAlt500_EvalSet.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_HighPileUp.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_MiddlePileUp.root"){
// void addClassBDT_2016(TString fname = "/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/EvalSetMC/LASTskim.MC16Bs_DOCAlt500_EvalSet_LowPileUp.root"){
void addClassBDT_2016(TString fname = ""){
  //=============================================
...
//15vars
  ...
  // TString xmlname("/afs/cern.ch/user/a/agrummer/www/bmumu/Data/May15/out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016test_BDT.weights.xml");
  TString xmlname("/Users/agrummer/cernbox/www/bmumu/Data/May15/May24npv/out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016test_BDT.weights.xml");
  //7vars_1
  // TString xmlname("/afs/cern.ch/user/a/agrummer/www/bmumu/Data/May15/out_MaxDepth6_MinNodeSize0.1_AdaBoostBeta0.2_NTrees500/weights/bdt2016test_BDT.weights.xml");
//7vars_2
  // TString xmlname("/afs/cern.ch/user/a/agrummer/www/bmumu/Data/May15/out_MaxDepth8_MinNodeSize1.0_AdaBoostBeta0.1_NTrees500/weights/bdt2016test_BDT.weights.xml");
  ...
  // for 2018 bdts?
  bdtMethod.Remove(bdtMethod.Index("test_BDT.weights.xml"),bdtMethod.Length());
...
//for 7 vars
  ...
  // newfname+=Form("_%s","BDT2016_15varsOptimized");
  newfname+=Form("_%s","BDT2016_May24bdt");
  // newfname+=Form("_%s","BDT2016_7varsOptimized");
  // newfname+=Form("_%s","BDT2016_7vars_1");
  // newfname+=Form("_%s","BDT2016_7vars_1");
