...
void addClassBDT_Run2_v2(TString fname = ""){
  //=============================================
  ...
  TString xmlname1(xmlFolder1 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_train2_test3.weights.xml");
  TString xmlname2(xmlFolder2 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_train3_test1.weights.xml");
  TString xmlname3(xmlFolder3 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_train1_test2.weights.xml");
