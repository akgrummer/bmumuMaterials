...
//root -l addClassBDT_Run2_june15.C"(\"/eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/AnalysisNtuples/Bsmumu/data15a16/v3/data1516Bs.root\")"
...
//check input dataset, xml weights file, and output tag
...
void addClassBDT_Run2_june15(TString fname = ""){
  //=============================================
  ...
  TString xmlFolder = "/eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/BDT/v2/weights/";
  TString xmlname1(xmlFolder + "bdt2016_train2_test3.weights.xml");
  TString xmlname2(xmlFolder + "bdt2016_train3_test1.weights.xml");
  TString xmlname3(xmlFolder + "bdt2016_train1_test2.weights.xml");
...
//XML variable names:
  ...
  for (Long64_t ievt=0; ievt<intree->GetEntries();ievt++) {
    ...
    pT_reader=BvtxPt;
    Lxy_reader=BvtxLxy;
    closeDOCA_reader = fabs(ClosTrackDCA)==999.0 ? -0.01 : sqrt(pow(ClosTrackDCA,2)+pow(ClosTrackZCA,2));
