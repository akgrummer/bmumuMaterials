...
void addClassBDT_Run2_3BDTs(TString fname = ""){
  //=============================================
  ...
  TString newfnameTag = "_EVALcombo_Jun12";//ww - with weights
...
// TString xmlname("/eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/BDT/bdt2016.weights.xml");
  ...
  TString xmlFolder1 = "/afs/cern.ch/user/a/agrummer/www/bmumu/Data/TrainedMVAs/Jun12/train2_test3/";//Official 15 vars with QLC and DDW
  TString xmlname1(xmlFolder1 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_BDT.weights.xml");

  TString xmlFolder2 = "/afs/cern.ch/user/a/agrummer/www/bmumu/Data/TrainedMVAs/Jun12/train3_test1/";//Official 15 vars with QLC and DDW
  TString xmlname2(xmlFolder2 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_BDT.weights.xml");
  
  TString xmlFolder3 = "/afs/cern.ch/user/a/agrummer/www/bmumu/Data/TrainedMVAs/Jun12/train1_test2/";//Official 15 vars with QLC and DDW
  TString xmlname3(xmlFolder3 + "out_MaxDepth4_MinNodeSize0.2_AdaBoostBeta0.5_NTrees500/weights/bdt2016_BDT.weights.xml");
...
//XML variable names:
  ...
  // reader1->AddVariable( "B_pT", &pT_reader );
  // reader1->AddVariable( "Lxy", &Lxy_reader );
  // reader1->AddVariable( "TMath::Sqrt(pow(closeTrkDCA,2)+pow(closeTrkZCA,2))", &closeDOCA_reader );
  // reader1->AddVariable( "closeTrkNtrksChi2", &ClosNTracksChi2_reader );
  // reader1->AddVariable( "TMath::Abs(d0Min_sig)", &d0MinSign_reader );

  // reader1->AddVariable( "TMath::Abs(d0Max_sig)", &d0MaxSign_reader );
  // reader1->AddVariable( "PlngMin2D", &BrefTrPlngMin2D_reader );
  // reader1->AddVariable( "chi2_PVSV_log2D", &chi2PVSVLog2D_reader );
  // reader1->AddVariable( "TMath::Abs(a_2D)", &a_2D_reader );
  // reader1->AddVariable( "DR", &DR_reader );

  // reader1->AddVariable( "B_iso_7_Chi2_5_LoosePt05", &iso7Chi26MedPt05_reader );
  // reader1->AddVariable( "TMath::Abs(B_IDtrks_deltaPhi)", &DPhi_reader );
  // reader1->AddVariable( "TMath::Abs(B_IDtrks_DCA)", &MuonsDCA_reader );
  // reader1->AddVariable( "Bvtx3DIP", &IP3D_reader );
  // reader1->AddVariable( "B_minChi2MuonsIPtoAnyPV", &Chi2Muons2AnyPV_reader );
  // // reader->AddVariable( "Npv", &Npv );


  // reader2->AddVariable( "B_pT", &pT_reader );
  // reader2->AddVariable( "Lxy", &Lxy_reader );
  // reader2->AddVariable( "TMath::Sqrt(pow(closeTrkDCA,2)+pow(closeTrkZCA,2))", &closeDOCA_reader );
  // reader2->AddVariable( "closeTrkNtrksChi2", &ClosNTracksChi2_reader );
  // reader2->AddVariable( "TMath::Abs(d0Min_sig)", &d0MinSign_reader );

  // reader2->AddVariable( "TMath::Abs(d0Max_sig)", &d0MaxSign_reader );
  // reader2->AddVariable( "PlngMin2D", &BrefTrPlngMin2D_reader );
  // reader2->AddVariable( "chi2_PVSV_log2D", &chi2PVSVLog2D_reader );
  // reader2->AddVariable( "TMath::Abs(a_2D)", &a_2D_reader );
  // reader2->AddVariable( "DR", &DR_reader );

  // reader2->AddVariable( "B_iso_7_Chi2_5_LoosePt05", &iso7Chi26MedPt05_reader );
  // reader2->AddVariable( "TMath::Abs(B_IDtrks_deltaPhi)", &DPhi_reader );
  // reader2->AddVariable( "TMath::Abs(B_IDtrks_DCA)", &MuonsDCA_reader );
  // reader2->AddVariable( "Bvtx3DIP", &IP3D_reader );
  // reader2->AddVariable( "B_minChi2MuonsIPtoAnyPV", &Chi2Muons2AnyPV_reader );
  // // reader->AddVariable( "Npv", &Npv );
