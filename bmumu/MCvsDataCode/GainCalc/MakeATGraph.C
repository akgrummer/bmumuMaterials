...
TStyle* AtlasStyle() 
{
  ...
  atlasStyle->SetPadBottomMargin(0.27);
  ...
  return atlasStyle;
    ...
    // called GainsCalc.py
    void MakeTheGraph( const Int_t cnt, Double_t* xvals, Double_t* yvals, Double_t *yvals2, Double_t* yError, Double_t *yvals3) {
      // const Int_t cnt2 = 5;
      ...
      //   gr3->SetLineWidth(2);
        ...
        gr1->GetYaxis()->SetTitle("Yield [Events/fb^{-1}]");
...
//95 reference line
        ...
        leg = new TLegend(0.224311, 0.773913, 0.414787, 0.864348,NULL,"brNDC");
