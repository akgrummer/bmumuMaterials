...
//=========  (Tue Aug 14 22:48:49 2018) by ROOT version6.10/04
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-4.835443,-7.380049,12.88608,0.6223769);
   pad1->SetFillColor(0);
   ...
   chi2_PVSV_log2D_dt16_SigMC__1->SetMaximum(0.7982861);
   ...
   chi2_PVSV_log2D_dt16_SigMC__1->GetXaxis()->SetTitle("Log(#chi^{2}_{xy})");
   ...
   chi2_PVSV_log2D_dt16_SigMC__1->GetYaxis()->SetTitle("a.u.");
   chi2_PVSV_log2D_dt16_SigMC__1->GetYaxis()->SetLabelFont(42);
   chi2_PVSV_log2D_dt16_SigMC__1->GetYaxis()->SetLabelSize(0.06);
   chi2_PVSV_log2D_dt16_SigMC__1->GetYaxis()->SetTitleSize(0.07);
   chi2_PVSV_log2D_dt16_SigMC__1->GetYaxis()->SetTitleOffset(0.72);
   ...
   dataSR__2->SetMaximum(0.7982861);
   ...
   dataSR__2->GetXaxis()->SetTitle("Log(#chi^{2}_{xy})");
