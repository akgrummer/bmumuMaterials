...
void d0Mean(TString compVar="", TString compMode="", Bool_t verbose=true, TString period = "")
{
...
if (NumberOfTrees>1){
  ...
  histogram[0]->SetMarkerColor(ColorWheel[0]);
  histogram[0]->SetLineColor(ColorWheel[0]);
