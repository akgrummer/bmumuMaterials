...
void cutBatchBsmumu(TString indir){
  TString outdir("/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimRightSideband");
  ...
  for (auto ievent=0; ievent<nevents; ievent++)
    {
      ...
      if (B_MUCALC_mass<5526.0 || B_MUCALC_mass>5966.0) continue; //only include right sideband
