...
void cutBatchBsmumu(TString indir){
  TString outdir("/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimB_VTX_mass");
  ...
  for (auto ievent=0; ievent<nevents; ievent++)
    {
      ...
      // if (B_VTX_mass<4766.0 || B_VTX_mass>5966.0 || (B_VTX_mass>=5166.0 && B_VTX_mass<=5526.0)) continue; //exclude blinded region
      if (B_fitChi2NDF>6.0) continue;

      bool pass_trigger = ( HLT_trigger->find("HLT_mu6_mu4_bBmumu_Lxy0") != HLT_trigger->end() );
