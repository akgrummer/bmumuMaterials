...
// void cutBatchBpJpsiKp(TString indir,  TString filter=""){
void cutBatchBpJpsiKp(TString filter=""){
  TString outdir("/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LastSkimOne2018Run");
  TString indir("/eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/BsMuMuVal1/skimmed_ntup/data18/BJpsiK");
  ...
  int EntriesOrig = ts->GetEntries();
    cout<< "Entries in original tree: "<< EntriesOrig <<endl;
  ...
  for (auto ievent=0; ievent<nevents; ievent++)
    {
      ...
      // if (!pass_grl){grlCut+=1; continue;}


      tf->Fill();
    }
    int EntriesFinal = tf->GetEntries();
    int AddCutsRemaining = EntriesOrig - AddCuts;
    int vtxMassWindowCutRemaining = EntriesOrig - vtxMassWindowCut;
    int B_fitChi2NDFCutRemaining = EntriesOrig - B_fitChi2NDFCut;
    int TriggerCutRemaining = EntriesOrig - TriggerCut;
    int JpsiFitCutRemaining = EntriesOrig - JpsiFitCut;
    int JpsiBlindCutRemaining = EntriesOrig - JpsiBlindCut;
    int KaonKinCutsRemaining = EntriesOrig - KaonKinCuts;
    int BKinCutRemaining = EntriesOrig - BKinCut;
    int MuonFlagCutRemaining = EntriesOrig - MuonFlagCut;
    int MuonTightCutRemaining = EntriesOrig - MuonTightCut;
    int MuonKinCutsRemaining = EntriesOrig - MuonKinCuts;

    cout<< "Entries in final tree: "<< EntriesFinal <<endl;
    cout<< "AddCuts Remaining: "<< AddCutsRemaining << endl;
    cout<< "vtxMassWindowCut Remaining: "<< vtxMassWindowCutRemaining << endl;
    cout<< "B_fitChi2NDFCut Remaining: "<< B_fitChi2NDFCutRemaining << endl;
    cout<< "TriggerCut Remaining: "<< TriggerCutRemaining << endl;
    cout<< "JpsiFitCut Remaining: "<< JpsiFitCutRemaining << endl;
    cout<< "JpsiBlindCut Remaining: "<< JpsiBlindCutRemaining << endl;
    cout<< "KaonKinCuts Remaining: "<< KaonKinCutsRemaining << endl;
    cout<< "BKinCut Remaining: "<< BKinCutRemaining << endl;
    cout<< "MuonFlagCut Remaining: "<< MuonFlagCutRemaining << endl;
    cout<< "MuonTightCut Remaining: "<< MuonTightCutRemaining << endl;
    cout<< "MuonKinCuts Remaining: "<< MuonKinCutsRemaining << endl;
