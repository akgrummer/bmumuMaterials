...
//  /eos/atlas/atlascerngroupdisk/phys-beauty/BsMuMuRun2/BsMuMuRel21Prod1/ntup/skimmed_data/v1
...
void cutBatchBsmumu(TString indir){
  ...
  TString outdir("/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/LASTskimMediumMuonsApr27");
  ...
  bool Muon1_isCombinedMuon, Muon2_isCombinedMuon, pass_grl, Muon1_isTight, Muon2_isTight, Muon1_isMedium, Muon2_isMedium;
  ...
  ts->SetBranchAddress("Muon1_isMedium",  &Muon1_isMedium);
  ts->SetBranchAddress("Muon2_isMedium",  &Muon2_isMedium);
  //  ts->SetBranchAddress("",  &);
  ...
  for (auto ievent=0; ievent<nevents; ievent++)
    {
      ...
      if (!Muon1_isMedium || !Muon2_isMedium || Muon1_isTight || Muon2_isTight) continue;
