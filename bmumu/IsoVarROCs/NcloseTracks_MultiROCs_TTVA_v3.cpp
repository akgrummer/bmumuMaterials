...
ColorIndex = 1;
TGraph* grROC_TTVA_tight_c1 = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
Double_t xmin = 0.;
Double_t xmax = 1.05;
grROC_TTVA_tight_c1->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_tight_c1->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_tight_c1->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_tight_c1->Draw("al2");
grROC_TTVA_tight_c1->Draw("al2");
...
TString Tag = "NcloseTracks_TTVA"+theYear+"_"+FileDate;
...
void NcloseTracks_MultiROCs_TTVA_v3(){
