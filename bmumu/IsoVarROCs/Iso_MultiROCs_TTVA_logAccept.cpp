...
TGraph* grROC_2016_TTVA_loose = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              iso_TTVA_loose, CutAddSig_2016_TTVA_loose,
                              iso_TTVA_loose, CutAddBkg_2016_TTVA_loose,
                              ColorIndex);
...
TGraph* grROC_2016_TTVA_nominal = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              iso_TTVA_nominal, CutAddSig_2016_TTVA_nominal,
                              iso_TTVA_nominal, CutAddBkg_2016_TTVA_nominal,
                              ColorIndex);
///////2016 all TTVA tight////////
...
TGraph* grROC_2016_TTVA_tight = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              iso_TTVA_tight, CutAddSig_2016_TTVA_tight,
                              iso_TTVA_tight, CutAddBkg_2016_TTVA_tight,
                              ColorIndex);
///////2016 all chi6////////
...
ColorIndex = 4;
TGraph* grROC_2016_AllTrks_Chi6 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 5;
TGraph* grROC_2016_AllTrks_Chi5 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 6;
TGraph* grROC_2016_AllTrks_Chi4 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
leg2->SetHeader("B Isolation"+theIDHits);
...
void Iso_MultiROCs_TTVA_logAccept(){
...
FileDate = "2019Jun6"; //ID hits revised run 1 with IBL included
    // makeROCplots("2016", FileDate);
    makeROCplots("2017", FileDate);
    // makeROCplots("2018", FileDate);
