...
ColorIndex = 1;
h2016data_TTVA_custom_c1 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_custom_c1, ColorIndex, FileDate);
ColorIndex = 2;
h2016data_TTVA_custom_c2 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_custom_c2, ColorIndex, FileDate);
ColorIndex = 4;
...
ColorIndex = 1;
h2016data_TTVA_custom_c1 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_custom_c7, ColorIndex, FileDate);
ColorIndex = 2;
h2016data_TTVA_custom_c2 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_custom_c2, ColorIndex, FileDate);
ColorIndex = 4;
...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    if(DataType.EqualTo("data")){
        ...
        h2016data_TTVA_custom_c1->Draw("e0psame");
        h2016data_TTVA_custom_c2->Draw("e0psame");
        ...
        h2016data_TTVA_custom_c1->Draw("hist e0 same");
        h2016data_TTVA_custom_c2->Draw("hist e0 same");
...
if(DataType.EqualTo("data")){
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h2016data_TTVA_custom_c1, "Custom TTVA WP and #chi^{2}_{SV} #leq 7","pe");
    }else{
        leg2->AddEntry(h2016data_TTVA_custom_c1, "Custom TTVA WP and #chi^{2}_{SV} #leq 1","pe");
    }
    leg2->AddEntry(h2016data_TTVA_custom_c2, "Custom TTVA WP and #chi^{2}_{SV} #leq 2","pe");
    if (theVar.EqualTo("DOCA")){
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h2016data_TTVA_custom_c1, "Custom TTVA WP and #chi^{2}_{SV} #leq 7","l");
    }else{
        leg2->AddEntry(h2016data_TTVA_custom_c1, "Custom TTVA WP and #chi^{2}_{SV} #leq 1","l");
    }
    leg2->AddEntry(h2016data_TTVA_custom_c2, "Custom TTVA WP and #chi^{2}_{SV} #leq 2","l");
    if (theVar.EqualTo("DOCA")){
...
delete h2016data_TTVA_custom_c1;
delete h2016data_TTVA_custom_c2;
...
void OtherIso_MultiVar_TTVA_v3() {
