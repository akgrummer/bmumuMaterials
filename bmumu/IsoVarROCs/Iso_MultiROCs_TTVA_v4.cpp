...
ColorIndex = 1;
TGraphErrors* grROC_2016_TTVA_custom = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 4;
TGraphErrors* grROC_2016_TTVA_custom_dr = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
// ColorIndex = 4;
// TGraphErrors* grROC_2016_TTVA_custom_dr = Iso_ROCs(EvalTreeSig_DR_1, EvalTreeBkg_DR_1,
...
Double_t xmin = 0.;
Double_t xmax = 1.05;                 
grROC_2016_TTVA_custom->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_2016_TTVA_custom->GetHistogram()->SetMaximum(ymax);   // along          
grROC_2016_TTVA_custom->GetHistogram()->SetMinimum(ymin);  //   Y
grROC_2016_TTVA_custom->Draw("al2");
