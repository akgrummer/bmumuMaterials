...
ColorIndex = 1;
TGraph* grROC_TTVA_custom_c7 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkDOCA_TTVA_custom_c7, CutAddSig_2016_Default,
                              closeTrkDOCA_TTVA_custom_c7, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////2////////closeTrkDOCA_TTVA_custom_c2
ColorIndex = 2;
TGraph* grROC_TTVA_custom_c2 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkDOCA_TTVA_custom_c2, CutAddSig_2016_Default,
                              closeTrkDOCA_TTVA_custom_c2, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////3////////closeTrkDOCA_all_c7
ColorIndex = 4;
TGraph* grROC_2016_all_c7 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
TString legName2 = mcName + " + "+ runName + " Custom TTVA WP + #chi^{2}_{SV}<7";
