...
ColorIndex = 1;
h_low = RetrieveHist("2018", DataType, myVar, ColorIndex, FileDate, "low");
ColorIndex = 2;
...
if (DataType.EqualTo("data")) {
    atlasLabel(0.23, 0.48, false, true, 1, true, false, true);
    leg2 = new TLegend(0.22, 0.2, 0.42, 0.46,NULL,"brNDC");
}
else if (DataType.EqualTo("mc")) {
    atlasLabel(0.23, 0.48, false, true, 1, true, false, true);
    leg2 = new TLegend(0.22, 0.2, 0.42, 0.46,NULL,"brNDC");
...
// c2->SaveAs(OutdirName + "Figures/VarComps2019Aug13_PU_Eff/BIso/"+typeDir+"/VarComp_"+Tag+".pdf");
c2->SaveAs(OutdirName + "Figures/VarComps2019Sep5_PU_Eff_2018/BIso/"+typeDir+"/VarComp_"+Tag+".pdf");
delete c2;
delete h_lowlow;
delete h_low;
delete h_medium;
...
void Iso_MultiVar_TTVA_v6_PU_eff(){
    TString FileDate = "";
    FileDate = "2019July30";
    // TString myPileup = "";
    // myPileup = "lowlow";
...
bool Run1set = false;
    VariableInfo myVar;
    //run 1 not working right now?? Aug 13, 2019
    myVar = Run1iso;
    Run1set = true;
