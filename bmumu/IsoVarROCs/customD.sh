...
cd v8IsoScripts/mixVars_customD1
rm out.txt err.txt
root -l -b -q DOCA_logAccept_ROCs_v8_customD1.cpp  >>out.txt 2>>err.txt
root -l -b -q DOCA_MultiROCs_TTVA_v8_customD1.cpp  >>out.txt 2>>err.txt
root -l -b -q OtherIso_MultiVar_TTVA_v8_customD1.cpp  >>out.txt 2>>err.txt
cd ../..

cd v8IsoScripts/mixVars_customD2
rm out.txt err.txt
root -l -b -q DOCA_logAccept_ROCs_v8_customD2.cpp  >>out.txt 2>>err.txt
root -l -b -q DOCA_MultiROCs_TTVA_v8_customD2.cpp  >>out.txt 2>>err.txt
root -l -b -q OtherIso_MultiVar_TTVA_v8_customD2.cpp  >>out.txt 2>>err.txt
cd ../..
