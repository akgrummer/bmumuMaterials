...
ColorIndex = 0;
TGraphErrors* grROC_2016_Default = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              Bisolation, CutAddSig_2016_Default,
                              Bisolation, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
/////// TTVA tight  + chi2SV<=2////////
TCut Weight_2016_TTVA_tight_c2 = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
TCut CutAddSig_2016_TTVA_tight_c2 = CutAdd*ExtraCut;
TCut CutAddBkg_2016_TTVA_tight_c2 = CutAdd*ExtraCut;
ColorIndex = 1;
TGraphErrors* grROC_2016_TTVA_tight_c2 = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                              B_Iso_TTVA_tight_c2, CutAddSig_2016_TTVA_tight_c2,
                              B_Iso_TTVA_tight_c2, CutAddBkg_2016_TTVA_tight_c2,
                              Weight_2016_TTVA_tight_c2, ColorIndex);
///////all tracks_chi2<= 5////////
TCut Weight_2016_all_c5 = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
TCut CutAddSig_2016_all_c5 = CutAdd*ExtraCut;
TCut CutAddBkg_2016_all_c5 = CutAdd*ExtraCut;
ColorIndex = 2;
TGraphErrors* grROC_2016_all_c5 = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
TCut Weight_2016_TTVA_tight_c2_dr = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
TCut CutAddSig_2016_TTVA_tight_c2_dr = CutAdd*ExtraCut;
TCut CutAddBkg_2016_TTVA_tight_c2_dr = CutAdd*ExtraCut;
ColorIndex = 4;
TGraphErrors* grROC_2016_TTVA_tight_c2_dr = Iso_ROCs(EvalTreeSig_DR_1, EvalTreeBkg_DR_1,
                              B_Iso_TTVA_tight_c2, CutAddSig_2016_TTVA_tight_c2_dr,
                              B_Iso_TTVA_tight_c2, CutAddBkg_2016_TTVA_tight_c2_dr,
                              Weight_2016_TTVA_tight_c2_dr, ColorIndex);
...
// ColorIndex = 5;
// TGraphErrors* grROC_2016_all_c5_dr = Iso_ROCs(EvalTreeSig_DR_1, EvalTreeBkg_DR_1,
...
// grROC_2016_Default->Draw("ae3");
// grROC_2016_TTVA_tight_c2->Draw("same e3");
// grROC_2016_all_c5->Draw("same e3");
Double_t ymin = 0.;
Double_t ymax = 1.05;
Double_t xmin = 0.;
Double_t xmax = 1.05;                 
grROC_2016_TTVA_tight_c2->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_2016_TTVA_tight_c2->GetHistogram()->SetMaximum(ymax);   // along          
grROC_2016_TTVA_tight_c2->GetHistogram()->SetMinimum(ymin);  //   Y
grROC_2016_TTVA_tight_c2->Draw("al2");
grROC_2016_Default->Draw("same l2");
grROC_2016_all_c5->Draw("same l2");
grROC_Run1->Draw("same l2");
grROC_2016_TTVA_tight_c2_dr->Draw("same l2");
...
leg2->SetHeader("B Isolation "+ExtraCut);
...
leg2->AddEntry(grROC_2016_TTVA_tight_c2_dr, legName4,"l");
