...
TH1F* h2016data_TTVA_tight_c1(NULL);
TH1F* h2016data_TTVA_tight_c2(NULL);
TH1F* h2016data_all_c1(NULL);
TH1F* h2016data_all_c2(NULL);
TH1F* hRun1(NULL);
Int_t ColorIndex = 0;
//
// closeTrkNtrks_TTVA_tight_c1
// closeTrkNtrks_TTVA_tight_c2
// closeTrkNtrks_all_c1
// closeTrkNtrks_all_c2

if (theVar.EqualTo("nCloseTrks")){
ColorIndex = 3;
hRun1 = RetrieveHistRun1(DataType, closeTrkNtrks, ColorIndex);
ColorIndex = 0;
h2016data_Default = RetrieveHist(theYear, DataType, closeTrkNtrks, ColorIndex, FileDate);
ColorIndex = 1;
h2016data_TTVA_tight_c1 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_tight_c1, ColorIndex, FileDate);
ColorIndex = 2;
h2016data_TTVA_tight_c2 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_tight_c2, ColorIndex, FileDate);
ColorIndex = 4;
h2016data_all_c1 = RetrieveHist(theYear, DataType, closeTrkNtrks_all_c1, ColorIndex, FileDate);
ColorIndex = 5;
h2016data_all_c2 = RetrieveHist(theYear, DataType, closeTrkNtrks_all_c2, ColorIndex, FileDate);
}//
// Int_t ColorIndex = 0;
//
// closeTrkDOCA_TTVA_tight_c7
// closeTrkDOCA_TTVA_tight_c2
// closeTrkDOCA_all_c7
// closeTrkDOCA_all_c2
else{
ColorIndex = 3;
hRun1 = RetrieveHistRun1(DataType, closeTrkDOCA, ColorIndex);
ColorIndex = 0;
h2016data_Default = RetrieveHist(theYear, DataType, closeTrkDOCA, ColorIndex, FileDate);
ColorIndex = 1;
h2016data_TTVA_tight_c1 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_tight_c7, ColorIndex, FileDate);
ColorIndex = 2;
h2016data_TTVA_tight_c2 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_tight_c2, ColorIndex, FileDate);
ColorIndex = 4;
h2016data_all_c1 = RetrieveHist(theYear, DataType, closeTrkDOCA_all_c7, ColorIndex, FileDate);
ColorIndex = 5;
h2016data_all_c2 = RetrieveHist(theYear, DataType, closeTrkDOCA_all_c2, ColorIndex, FileDate);
}
//
// ColorIndex = 4;
...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    if(DataType.EqualTo("data")){
        ...
        h2016data_TTVA_tight_c1->Draw("e0psame");
        h2016data_TTVA_tight_c2->Draw("e0psame");
        ...
        h2016data_TTVA_tight_c1->Draw("hist e0 same");
        h2016data_TTVA_tight_c2->Draw("hist e0 same");
...
if (DataType.EqualTo("data")) {
    ...
    if (theVar.EqualTo("nCloseTrks")){
        ...
        leg2 = new TLegend(0.63, 0.55, 0.83, 0.8,NULL,"brNDC");
        }
    leg2->SetHeader(theYear + theRunNumber);
}
else if (DataType.EqualTo("mc")) {
    atlasLabel(0.62, 0.85, false, true, 1, true, false, true);
    // atlasLabel(0.2, 0.83, false, true, 1, true, false, true);
    leg2 = new TLegend(0.63, 0.6, 0.83, 0.85,NULL,"brNDC");
    // leg2 = new TLegend(0.22, 0.57, 0.42, 0.8,NULL,"brNDC");
    leg2->SetHeader(mcName + theRunNumber);
}
...
if(DataType.EqualTo("data")){
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h2016data_TTVA_tight_c1, "TTVA Tight WP and #chi^{2}_{SV} #leq 7","pe");
    }else{
        leg2->AddEntry(h2016data_TTVA_tight_c1, "TTVA Tight WP and #chi^{2}_{SV} #leq 1","pe");
    }
    leg2->AddEntry(h2016data_TTVA_tight_c2, "TTVA Tight WP and #chi^{2}_{SV} #leq 2","pe");
    if (theVar.EqualTo("DOCA")){
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h2016data_TTVA_tight_c1, "TTVA Tight WP and #chi^{2}_{SV} #leq 7","l");
    }else{
        leg2->AddEntry(h2016data_TTVA_tight_c1, "TTVA Tight WP and #chi^{2}_{SV} #leq 1","l");
    }
    leg2->AddEntry(h2016data_TTVA_tight_c2, "TTVA Tight WP and #chi^{2}_{SV} #leq 2","l");
    if (theVar.EqualTo("DOCA")){
...
delete h2016data_TTVA_tight_c1;
delete h2016data_TTVA_tight_c2;
...
void OtherIso_MultiVar_TTVA_v2() {
