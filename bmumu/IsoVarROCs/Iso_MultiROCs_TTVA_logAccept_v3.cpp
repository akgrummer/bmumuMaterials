...
ColorIndex = 1;
TGraphErrors* grROC_2016_TTVA_tight_c2 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 4;
TGraphErrors* grROC_2016_TTVA_tight_c2_dr = Iso_logAccept_ROCs(EvalTreeSig_DR_1, EvalTreeBkg_DR_1,
...
// grROC_2016_TTVA_tight_c2->Draw("same l");
...
grROC_2016_all_c5->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_tight_c1->Draw("al2");
grROC_2016_all_c5->Draw("al2");
grROC_2016_Default->Draw("same l2");
grROC_2016_TTVA_tight_c2->Draw("same l2");
...
TString Tag = "TTVA_Chi2"+theYear+"_logAccept_"+FileDate;
...
void Iso_MultiROCs_TTVA_logAccept_v3(){
...
FileDate = "2019July1"; //ID hits revised run 1 with IBL included
TString ExtraCut = ""; 
// ExtraCut = "Lxy>0.2"; 
// ExtraCut = "a_2D<0.1"; 
