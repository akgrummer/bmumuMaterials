TGraphErrors* Iso_ROCs(TTree* EvalTreeSig, TTree* EvalTreeBkg, 
...
for(int i = 0; i<NumberOfBinsROC; i++){
  // cout<<i<<endl;
  SigTestEff.push_back((hROCSig->Integral(NumberOfBinsROC-i, NumberOfBinsROC))/(hROCSig->Integral(1, NumberOfBinsROC)));
  BkgTestRej.push_back(1-(hROCBkg->Integral(NumberOfBinsROC-i, NumberOfBinsROC)/(hROCBkg->Integral(1, NumberOfBinsROC))));
  BkgTestEff.push_back((hROCBkg->Integral(NumberOfBinsROC-i, NumberOfBinsROC))/(hROCBkg->Integral(1, NumberOfBinsROC)));
