...
// TString filenameBkg_2016 = DirName + theYear+"All/LASTskim_"+theYear+"_All_2019Jun6.root";//chi2<2 instead of <1
TCut PUcut = "";
...
TString filenameBkg_2016 = DirName + theYear+"All/LASTskim_"+theYear+"_All_"+FileDate+".root";//chi2<2 instead of <1
...
if (theYear.EqualTo("2016")){
 ...
 // filenameSig_2016 = DirName + mcName+"All/LASTskim_"+mcName+"_All_2019Jun6.root";//chi2<2 instead of <1
...
ColorIndex = 0;
TGraph* grROC_2016_Default = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkNtrks, CutAddSig_2016_Default,
                              closeTrkNtrks, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////1////////closeTrkNtrks_TTVA_custom_c1
ColorIndex = 1;
TGraph* grROC_TTVA_custom_c1 = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkNtrks_TTVA_custom_c1, CutAddSig_2016_Default,
                              closeTrkNtrks_TTVA_custom_c1, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////2////////closeTrkNtrks_TTVA_custom_c2
ColorIndex = 2;
TGraph* grROC_TTVA_custom_c2 = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkNtrks_TTVA_custom_c2, CutAddSig_2016_Default,
                              closeTrkNtrks_TTVA_custom_c2, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////3////////closeTrkNtrks_all_c1
ColorIndex = 4;
TGraph* grROC_2016_all_c1 = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkNtrks_all_c1, CutAddSig_2016_Default,
                              closeTrkNtrks_all_c1, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////4////////closeTrkNtrks_all_c2
ColorIndex = 5;
TGraph* grROC_2016_all_c2 = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
...
Double_t xmin = 0.;
Double_t xmax = 1.05;
grROC_TTVA_custom_c1->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_custom_c1->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_custom_c1->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
grROC_TTVA_custom_c1->Draw("al2");
...
TString legName2 = mcName + " + "+ runName + " Custom TTVA WP + #chi^{2}_{SV}<1";
leg2->AddEntry(grROC_TTVA_custom_c1, legName2,"l");
TString legName3 = mcName + " + "+ runName + " Custom TTVA WP + #chi^{2}_{SV}<2";
...
void NcloseTracks_MultiROCs_TTVA_v4(){
