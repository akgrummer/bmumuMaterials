...
grROC_DefaultNEW->GetHistogram()->SetMinimum(ymin);  //   
...
//     theTrACK, derivations = " #chi^{2}_{SV}<=1";
// }
// if (FileDate.EqualTo("2019Jun17")){
//     theTrACK, derivations = " #chi^{2}_{SV}<=2";
// }
// if (FileDate.EqualTo("2019Jun17_2")) {
//     theTrACK, derivations = " #chi^{2}_{SV}<=4";
// }
...
// leg2->SetHeader("Number of Close TrACK, derivations to B DV");
...
//     }
TString legName3 = mcName + " + "+ theYear + " BCM, derivation";
leg2->AddEntry(grROC_1516, legName3,"l");
TString legName2 = mcName + " + "+ theYear + " ACK, derivation";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_1516D/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
// TFile ofile(OutdirName + "RootFiles/ROC_"+Tag+".root", "recreate");
// // grROC_Run1->Write();
// grROC_Default->Write();
// grROC_AllTrACK, derivations->Write();
// grROC_AllTrACK, derivations_PVweights->Write();
// // grROC_2017->Write();
// // grROC_2018->Write();
...
void NcloseTracks_logAccept_ROCs_v8_1516D(){
