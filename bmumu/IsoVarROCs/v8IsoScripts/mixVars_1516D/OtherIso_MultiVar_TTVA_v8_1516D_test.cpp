...
DirName= "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v2/";}
else{DirName= "/eos/home-a/agrummer/BsmumuData/2020nTuples/FinalSkim/v1/";}
ColorIndex = 2;
...
leg2->Draw();
    ...
    if (drawResiduals) {
        ...
        hres->SetMaximum(1.000001);   // along          
        hres->SetMinimum(0.999999);  //   Y 
...
void OtherIso_MultiVar_TTVA_v8_1516D_test() {
