...
grROC_customApprox->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_customApprox->GetHistogram()->SetMaximum(ymax);   // along          
grROC_customApprox->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
// grROC_TTVA_custom_c7OLD->Draw("al2");
// grROC_TTVA_custom_c7NEW->Draw("al2");
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_customD2/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void DOCA_logAccept_ROCs_v8_customD2(){
