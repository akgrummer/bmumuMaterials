...
grROC_TTVA_loose_c7NEW->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_loose_c7NEW->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_loose_c7NEW->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c7->Draw("al2");
// grROC_TTVA_loose_c7OLD->Draw("al2");
grROC_TTVA_loose_c7NEW->Draw("al2");
...
// TString legName3 = mcName + " + "+ theYear + " BGL, derivation";
// leg2->AddEntry(grROC_looseTrkPerigee, legName3,"l");
// TString legName2 = mcName + " + "+ theYear + " Loose TVA Approx., new nTuple, Derivation";
TString legName2 = mcName + " + "+ theYear + " BGM, derivation";
leg2->AddEntry(grROC_looseApprox, legName2,"l");
// TString legName1 = mcName + " + "+ theYear + " Loose TVA new nTuple, from Trks";
TString legName1 = mcName + " + "+ theYear + " BGM, from trks";
leg2->AddEntry(grROC_TTVA_loose_c7NEW, legName1,"l");
// TString legName4 = mcName + " + "+ theYear + " Loose TVA old nTuple, from Trks";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_looseD1/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void DOCA_MultiROCs_TTVA_v8_looseD1(){
