...
leg2->AddEntry(h_TTVA_loose_drNEW, "Loose TVA new nTuple, from Trks","l");
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Feb19_VarBinned_v8_mixVars_loose/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
delete c2;
...
void Iso_MultiVar_TTVA_v8_loose(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
