...
ColorIndex = 0;
h_1516 = RetrieveHist(theYear, DataType, closeTrkNtrksChi2_LooSiHi1Pt05_corc2cnt, ColorIndex, FileDate, myPileup);
ColorIndex = 4;
...
ColorIndex = 0;
h_1516 = RetrieveHist(theYear, DataType, closeTrkDOCA_LooSiHi1Pt05_corc2cnt, ColorIndex, FileDate, myPileup);
ColorIndex = 4;
h_customApprox = RetrieveHist(theYear, DataType, closeTrkDOCA_LooSiHi1Pt05_corc2cnt_custom, ColorIndex, FileDate, myPileup);
ColorIndex = 2;
h_customTrkPerigee = RetrieveHist(theYear, DataType, closeTrkDOCA_LooSiHi1Pt05_f2dc2_custom, ColorIndex, FileDate, myPileup);
ColorIndex = 1;
...
if(DataType.EqualTo("data")){
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h_customApprox, "Custom TVA Approx.","pe");
        leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee","pe");
        leg2->AddEntry(h_looseApprox, "Loose TVA Approx","pe");
        leg2->AddEntry(h_looseTrkPerigee, "Loose TVA","pe");
    }else{
        leg2->AddEntry(h_customApprox, "Custom TVA Approx.","pe");
        leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee","pe");
        leg2->AddEntry(h_looseApprox, "Loose TVA Approx","pe");
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h_customApprox, "Custom TVA Approx.","l");
        leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee","l");
        leg2->AddEntry(h_looseApprox, "Loose TVA Approx","l");
        leg2->AddEntry(h_looseTrkPerigee, "Loose TVA","l");
    }else{
        leg2->AddEntry(h_customApprox, "Custom TVA Approx.","l");
        leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee","l");
        leg2->AddEntry(h_looseApprox, "Loose TVA Approx","l");
