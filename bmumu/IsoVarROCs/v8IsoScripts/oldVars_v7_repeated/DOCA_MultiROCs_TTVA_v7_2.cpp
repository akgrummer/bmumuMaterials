...
ColorIndex = 0;
TGraph* grROC_Default = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_comp, CutAddSig_Default,
                              closeTrkDOCA_comp, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
///////1////////closeTrkDOCA_TTVA_custom_c7
ColorIndex = 1;
TGraph* grROC_TTVA_custom_c7 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_TTVA_custom_c7, CutAddSig_Default,
                              closeTrkDOCA_TTVA_custom_c7, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
///////2////////closeTrkDOCA_TTVA_loose_c7
ColorIndex = 2;
TGraph* grROC_TTVA_loose_c7 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_TTVA_loose_c7, CutAddSig_Default,
                              closeTrkDOCA_TTVA_loose_c7, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
///////3////////closeTrkDOCA_all_c7
// ColorIndex = 4;
// TGraph* grROC_all_c7 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
//                               closeTrkDOCA_all_c7, CutAddSig_Default,
//                               closeTrkDOCA_all_c7, CutAddBkg_Default,
//                               Weight_Default, ColorIndex);
// ///////4////////closeTrkDOCA_all_c2
// ColorIndex = 5;
// TGraph* grROC_all_c2 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
//                               closeTrkDOCA_all_c2, CutAddSig_Default,
//                               closeTrkDOCA_all_c2, CutAddBkg_Default,
//                               Weight_Default, ColorIndex);
// ///////2016 all chi6////////
// TCut CutAddSig_AllTrks_Chi6 = CutAdd*RunNumberCut*"PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
// TCut CutAddBkg_AllTrks_Chi6 = CutAdd;
// ColorIndex = 4;
// TGraph* grROC_AllTrks_Chi6 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
//                               iso_AllTrks_Chi6, CutAddSig_AllTrks_Chi6,
//                               iso_AllTrks_Chi6, CutAddBkg_AllTrks_Chi6,
//                               ColorIndex);
// ///////2016 all chi5////////
// TCut CutAddSig_AllTrks_Chi5 = CutAdd*RunNumberCut*"PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
// TCut CutAddBkg_AllTrks_Chi5 = CutAdd;
// ColorIndex = 5;
// TGraph* grROC_AllTrks_Chi5 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
//                               iso_AllTrks_Chi5, CutAddSig_AllTrks_Chi5,
//                               iso_AllTrks_Chi5, CutAddBkg_AllTrks_Chi5,
//                               ColorIndex);
// ///////2016 all chi4////////
// TCut CutAddSig_AllTrks_Chi4 = CutAdd*RunNumberCut*"PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
// TCut CutAddBkg_AllTrks_Chi4 = CutAdd;
// ColorIndex = 6;
// TGraph* grROC_AllTrks_Chi4 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
//                               iso_AllTrks_Chi4, CutAddSig_AllTrks_Chi4,
//                               iso_AllTrks_Chi4, CutAddBkg_AllTrks_Chi4,
//                               ColorIndex);
...
Double_t xmin = 0.;
Double_t xmax = 1.05;
grROC_TTVA_custom_c7->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_custom_c7->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_custom_c7->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c7->Draw("al2");
grROC_TTVA_custom_c7->Draw("al2");
grROC_TTVA_loose_c7->Draw("same l2");
...
TString legName2 = mcName + " + "+ runName + " Custom TVA WP + #chi^{2}_{SV}<7";
leg2->AddEntry(grROC_TTVA_custom_c7, legName2,"l");
TString legName3 = mcName + " + "+ runName + " Loose TVA WP + #chi^{2}_{SV}<7";
leg2->AddEntry(grROC_TTVA_loose_c7, legName3,"l");
