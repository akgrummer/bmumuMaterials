...
ColorIndex = 0;
TGraph* grROC_Default = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
grROC_TTVA_custom_c7->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
