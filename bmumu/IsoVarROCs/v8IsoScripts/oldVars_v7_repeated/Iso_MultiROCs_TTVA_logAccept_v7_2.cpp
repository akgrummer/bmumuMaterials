...
ColorIndex = 0;
TGraphErrors* grROC_Default = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 1;
TGraphErrors* grROC_TTVA_loose = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 2;
TGraphErrors* grROC_TTVA_custom_dr = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 4;
TGraphErrors* grROC_all_c5 = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
Double_t xmin = 0;
Double_t xmax = 0.8;
grROC_all_c5->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_all_c5->GetHistogram()->SetMaximum(ymax);   // along          
grROC_all_c5->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
grROC_all_c5->Draw("al2");
...
TString legName2 = mcName + " + "+ runName + " Loose TVA WP, #Delta R <1.0";
leg2->AddEntry(grROC_TTVA_loose, legName2,"l");
TString legName4 = mcName + " + "+ runName + " Custom TVA WP, #Delta R <1.0";
leg2->AddEntry(grROC_TTVA_custom_dr, legName4,"l");
TString legName3 = mcName + " + "+ runName + " All Tracks and #chi^{2}_{PV} #leq 5";
leg2->AddEntry(grROC_all_c5, legName3,"l");
...
void Iso_MultiROCs_TTVA_logAccept_v7_2(){
