...
ColorIndex = 0;
TGraphErrors* grROC_Default = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 1;
TGraphErrors* grROC_TTVA_loose = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 4;
TGraphErrors* grROC_TTVA_custom_dr = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 2;
TGraphErrors* grROC_all_c5 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
Double_t xmin = 0.;
Double_t xmax = 1.05;                 
grROC_TTVA_loose->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_loose->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_loose->GetHistogram()->SetMinimum(ymin);  //   Y
grROC_TTVA_loose->Draw("al2");
grROC_Default->Draw("same l2");
grROC_all_c5->Draw("same l2");
