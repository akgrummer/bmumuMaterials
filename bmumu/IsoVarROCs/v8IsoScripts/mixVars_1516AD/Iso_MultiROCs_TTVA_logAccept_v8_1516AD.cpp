...
// grROC_DefaultOLD
// grROC_all_c5OLD
grROC_all_c5NEW->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_all_c5NEW->GetHistogram()->SetMaximum(ymax);   // along          
grROC_all_c5NEW->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
// grROC_all_c5OLD->Draw("al2");
// grROC_DefaultOLD->Draw("same l2");
grROC_all_c5NEW->Draw("al2");
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
// c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".png");
...
void Iso_MultiROCs_TTVA_logAccept_v8_1516AD(){
