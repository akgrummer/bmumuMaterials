...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    h_all_c5NEW->GetYaxis()->SetNdivisions(4,5,0); //4,5,0
    h_all_c5NEW->GetXaxis()->SetLabelOffset(0.028);
    h_all_c5NEW->GetYaxis()->SetTitleSize(0.08);
    h_all_c5NEW->GetYaxis()->SetTitleOffset(0.9);
    h_all_c5NEW->GetYaxis()->SetLabelSize(0.08);
    // cout<<"DEBUG: 2"<<endl;
    Double_t ymin;
    Double_t ymax;
    Double_t xmin;
...
// h_all_c5NEW
// h_all_c5OLD
        // h_all_c5OLD->SetMaximum(ymax);   // along          
        // h_all_c5OLD->SetMinimum(ymin);  //   Y  
        // h_all_c5OLD->Draw("e0p");
        h_all_c5NEW->SetMaximum(ymax);   // along          
        h_all_c5NEW->SetMinimum(ymin);  //   Y  
        h_all_c5NEW->Draw("e0p");
        // h_DefaultOLD->Draw("e0psame");
        // h_DefaultNEW->Draw("e0psame");
        // h_1516->Draw("e0psame");
        h_asRun1->SetMarkerStyle(23);
...
leg2->AddEntry(h_asRun1, "BDI, derivation","pe");
// leg2->AddEntry(h_all_c5NEW, "All tracks, chi2<5, new nTuple","pe");
leg2->AddEntry(h_all_c5NEW, "BDI, from trks","pe");
// leg2->AddEntry(h_all_c5OLD, "All tracks, chi2<5, old nTuple","pe");
// leg2->AddEntry(h_all_c5OLD, "BDI, from trks, old nTuple","pe");
}else if(DataType.EqualTo("mc")){
...
leg2->AddEntry(h_asRun1, "BDI, derivation","l");
// leg2->AddEntry(h_all_c5NEW, "All tracks, chi2<5, new nTuple","l");
leg2->AddEntry(h_all_c5NEW, "BDI, from trks","l");
// leg2->AddEntry(h_all_c5OLD, "All tracks, chi2<5, old nTuple","l");
// leg2->AddEntry(h_all_c5OLD, "BDI, from trks, old nTuple","l");
    }
// cout<<"DEBUG: 6"<<endl;
...
leg2->Draw();
    ...
    if (drawResiduals) {
        pad2->cd();
        hres = (TH1F*)h_all_c5NEW->Clone("hres");
        hres->Sumw2();
        hres->Divide(h_all_c5NEW,h_asRun1,1.0,1.0);
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Mar6_VarBinned_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
// c2->SaveAs(OutdirName + "Figures/VarComps2020Mar6_VarBinned_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".png");
delete c2;
delete h_asRun1;
delete h_1516;
delete h_DefaultNEW;
...
void Iso_MultiVar_TTVA_v8_1516AD(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
