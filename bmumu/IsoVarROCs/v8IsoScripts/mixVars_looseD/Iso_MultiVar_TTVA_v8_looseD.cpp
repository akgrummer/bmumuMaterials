...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    h_TTVA_loose_drNEW->GetYaxis()->SetNdivisions(4,5,0); //4,5,0
    h_TTVA_loose_drNEW->GetXaxis()->SetLabelOffset(0.028);
    h_TTVA_loose_drNEW->GetYaxis()->SetTitleSize(0.08);
    h_TTVA_loose_drNEW->GetYaxis()->SetTitleOffset(0.9);
    h_TTVA_loose_drNEW->GetYaxis()->SetLabelSize(0.08);
    // cout<<"DEBUG: 2"<<endl;
    Double_t ymin;
    Double_t ymax;
    Double_t xmin;
    ...
    if(DataType.EqualTo("data")){
        ...
        // h_TTVA_loose_drNEW
        // h_TTVA_loose_drOLD
        h_TTVA_loose_drNEW->SetMaximum(ymax);   // along          
        h_TTVA_loose_drNEW->SetMinimum(ymin);  //   Y  
        // h_TTVA_loose_drOLD->Draw("e0p");
        h_TTVA_loose_drNEW->Draw("e0p");
        h_looseDerivation->SetMarkerStyle(23);
        ...
        h_TTVA_loose_drNEW->SetMaximum(ymax);   // along          
        h_TTVA_loose_drNEW->SetMinimum(ymin);  //   Y  
        h_TTVA_loose_drNEW->SetMaximum(5.);
        // h_TTVA_loose_drOLD->Draw("hist e0");
        // h_TTVA_loose_drNEW->SetLineStyle(4);
        h_TTVA_loose_drNEW->Draw("hist e0");
        h_looseDerivation->SetLineStyle(2);
...
leg2->AddEntry(h_looseDerivation, "BGJ, derivation","pe");
leg2->AddEntry(h_TTVA_loose_drNEW, "BGJ approx., from trks","pe");
// leg2->AddEntry(h_TTVA_loose_drOLD, "Loose TVA old nTuple, from Trks","pe");
}else if(DataType.EqualTo("mc")){
// if (!myPileup.EqualTo("high"))
leg2->AddEntry(h_looseDerivation, "BGJ, derivation","l");
leg2->AddEntry(h_TTVA_loose_drNEW, "BGJ approx., from trks","l");
// leg2->AddEntry(h_TTVA_loose_drOLD, "Loose TVA old nTuple, from Trks","l");
    }
// cout<<"DEBUG: 6"<<endl;
...
leg2->Draw();
    ...
    if (drawResiduals) {
        pad2->cd();
        hres = (TH1F*)h_TTVA_loose_drNEW->Clone("hres");
        hres->Sumw2();
        hres->Divide(h_TTVA_loose_drNEW,h_looseDerivation,1.0,1.0);
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Mar6_VarBinned_v8_mixVars_looseD/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
delete c2;
...
void Iso_MultiVar_TTVA_v8_looseD(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
