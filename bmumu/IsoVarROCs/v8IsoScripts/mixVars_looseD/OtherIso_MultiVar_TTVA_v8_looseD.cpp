...
leg2->Draw();
    ...
    if (drawResiduals) {
        ...
        hres->Sumw2();
        hres->Divide(h_looseApprox,hdata_TTVA_looseNEW,1.0,1.0);
        ...
        hres2 = (TH1F*)hdata_TTVA_looseNEW->Clone("hres2");
        hres2->Sumw2();
        hres2->Divide(h_looseTrkPerigee,hdata_TTVA_looseNEW,1.0,1.0);
...
void OtherIso_MultiVar_TTVA_v8_looseD() {
