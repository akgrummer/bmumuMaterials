...
leg2->Draw();
    ...
    if (drawResiduals) {
        ...
        hres->Sumw2();
        hres->Divide(hdata_TTVA_customNEW,h_customApprox,1.0,1.0);
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Mar6_VarBinned_v8_mixVars_customD1/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
delete c2;
...
void OtherIso_MultiVar_TTVA_v8_customD1() {
