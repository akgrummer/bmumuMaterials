...
// grROC_looseApprox
// grROC_looseTrkPerigee
grROC_looseApprox->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_looseApprox->GetHistogram()->SetMaximum(ymax);   // along          
grROC_looseApprox->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c7->Draw("al2");
...
TString legName2 = mcName + " + "+ runName + " Custom TVA Approx.";
leg2->AddEntry(grROC_customApprox, legName2,"l");
TString legName3 = mcName + " + "+ runName + " Custom TVA Trk Perigee";
leg2->AddEntry(grROC_customTrkPerigee, legName3,"l");
TString legName4 = mcName + " + "+ runName + " Loose TVA Approx";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Feb19_v8_newVars/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void DOCA_MultiROCs_TTVA_v8_newVars(){
