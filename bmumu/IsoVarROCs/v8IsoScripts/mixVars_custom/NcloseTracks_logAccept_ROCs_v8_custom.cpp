...
TString legName2 = mcName + " + "+ theYear + " Custom TVA Approx., new nTuple, Derviation";
leg2->AddEntry(grROC_customApprox, legName2,"l");
TString legName4 = mcName + " + "+ theYear + " Custom TVA new nTuple, from Trks";
leg2->AddEntry(grROC_TTVA_custom_c2NEW, legName4,"l");
TString legName5 = mcName + " + "+ theYear + " Custom TVA old nTuple, from Trks";
leg2->AddEntry(grROC_TTVA_custom_c2OLD, legName5,"l");
...
void NcloseTracks_logAccept_ROCs_v8_custom(){
