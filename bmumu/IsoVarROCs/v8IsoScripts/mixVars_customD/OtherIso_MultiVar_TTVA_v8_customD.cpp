...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    hdata_TTVA_customNEW->GetYaxis()->SetNdivisions(4,5,0); //4,5,0
    hdata_TTVA_customNEW->GetXaxis()->SetLabelOffset(0.028);
    hdata_TTVA_customNEW->GetYaxis()->SetTitleSize(0.08);
    hdata_TTVA_customNEW->GetYaxis()->SetTitleOffset(0.9);
    hdata_TTVA_customNEW->GetYaxis()->SetLabelSize(0.08);
    Double_t ymin;
    Double_t ymax;
    Double_t xmin;
    Double_t xmax;
...
// hdata_TTVA_customNEW
// hdata_TTVA_customOLD
            hdata_TTVA_customNEW->GetXaxis()->SetRangeUser(xmin, xmax);// along X
            hdata_TTVA_customNEW->SetMaximum(ymax);   // along          
            hdata_TTVA_customNEW->SetMinimum(ymin);  //   Y  
        // hdata_TTVA_customOLD->Draw("e0p");
        hdata_TTVA_customNEW->Draw("e0p");
        h_customApprox->SetMarkerStyle(23);
        h_customApprox->Draw("e0psame");
        h_customTrkPerigee->SetMarkerStyle(22);
        ...
        hdata_TTVA_customNEW->Draw("hist e0");
        h_customApprox->SetLineStyle(4);
        h_customApprox->Draw("hist e0 same");
        h_customTrkPerigee->SetLineStyle(2);
...
if(DataType.EqualTo("data")){
    ...
    if (theVar.EqualTo("DOCA")){
        ...
        leg2->AddEntry(h_customTrkPerigee, "BEL, derivation","pe");
        // leg2->AddEntry(h_customApprox, "Custom TVA Approx., new nTuple, derivation","pe");
        leg2->AddEntry(h_customApprox, "BFM, derivation","pe");
        // leg2->AddEntry(hdata_TTVA_customNEW, "Custom TVA new nTuple, from Trks","pe");
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, from trks","pe");
...
// Custom TVA Approx., new nTuple, derivation
// Custom TVA Trk Perigee, new nTuple, derivation
    ...
    if (theVar.EqualTo("DOCA")){
        leg2->AddEntry(h_customTrkPerigee, "BEL, derivation","l");
        leg2->AddEntry(h_customApprox, "BFM, derivation","l");
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, from trks","l");
...
leg2->Draw();
    ...
    if (drawResiduals) {
        pad2->cd();
        hres = (TH1F*)hdata_TTVA_customNEW->Clone("hres");
        hres->Sumw2();
        hres->Divide(h_customApprox,hdata_TTVA_customNEW,1.0,1.0);
        ...
        hres2 = (TH1F*)hdata_TTVA_customNEW->Clone("hres2");
        hres2->Sumw2();
        hres2->Divide(h_customTrkPerigee,hdata_TTVA_customNEW,1.0,1.0);
...
void OtherIso_MultiVar_TTVA_v8_customD() {
