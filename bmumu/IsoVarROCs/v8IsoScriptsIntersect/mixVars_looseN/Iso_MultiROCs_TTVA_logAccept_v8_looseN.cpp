...
ColorIndex = 1;
TGraphErrors* grROC_TTVA_looseNEW = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 5;
TGraphErrors* grROC_TTVA_looseOLD = Iso_logAccept_ROCs(EvalTreeSig2, EvalTreeBkg2,
...
grROC_TTVA_looseOLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
...
void Iso_MultiROCs_TTVA_logAccept_v8_looseN(){
