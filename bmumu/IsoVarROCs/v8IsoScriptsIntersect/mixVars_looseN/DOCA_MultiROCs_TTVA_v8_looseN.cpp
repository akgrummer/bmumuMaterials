...
///////3///////
ColorIndex = 4;
TGraph* grROC_looseApprox = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose, CutAddSig_Default,
                              closeTrkDOCA_LooSiHi1Pt05_corc2cnt_loose, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
///////4//////
ColorIndex = 2;
TGraph* grROC_looseTrkPerigee = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose, CutAddSig_Default,
                              closeTrkDOCA_LooSiHi1Pt05_f2dc2_loose, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
///////2///////
ColorIndex = 1;
TGraph* grROC_TTVA_loose_c7NEW = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_TTVA_loose_c7, CutAddSig_Default,
                              closeTrkDOCA_TTVA_loose_c7, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
...
/////////////
ColorIndex = 5;
TGraph* grROC_TTVA_loose_c7OLD = Iso_ROCs(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkDOCA_TTVA_loose_c7, CutAddSig_Default,
                              closeTrkDOCA_TTVA_loose_c7, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
ifilenameBkg2->Close();
...
// grROC_looseApprox
// grROC_looseTrkPerigee
// grROC_TTVA_loose_c7NEW
// grROC_TTVA_loose_c7OLD
grROC_TTVA_loose_c7OLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_loose_c7OLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_loose_c7OLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c7->Draw("al2");
grROC_TTVA_loose_c7OLD->Draw("al2");
grROC_TTVA_loose_c7NEW->Draw("same l2");
// grROC_looseApprox->Draw("same l2");
...
// Loose TVA Approx., new nTuple, Derivation
// Loose TVA new nTuple, Derivation
// TString legName3 = mcName + " + "+ theYear + " Loose TVA new nTuple, Derivation";
// leg2->AddEntry(grROC_looseTrkPerigee, legName3,"l");
// TString legName2 = mcName + " + "+ theYear + " Loose TVA Approx., new nTuple, Derivation";
// leg2->AddEntry(grROC_looseApprox, legName2,"l");
TString legName1 = mcName + " + "+ theYear + " BGM, new nTuple, from trks";
leg2->AddEntry(grROC_TTVA_loose_c7NEW, legName1,"l");
TString legName4 = mcName + " + "+ theYear + " BGM, old nTuple, from trks";
leg2->AddEntry(grROC_TTVA_loose_c7OLD, legName4,"l");
...
void DOCA_MultiROCs_TTVA_v8_looseN(){
