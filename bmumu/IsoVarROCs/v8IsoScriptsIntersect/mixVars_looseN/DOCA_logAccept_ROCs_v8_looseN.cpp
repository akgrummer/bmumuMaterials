...
///////2///////
ColorIndex = 1;
TGraph* grROC_TTVA_loose_c7NEW = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
/////////////
ColorIndex = 5;
TGraph* grROC_TTVA_loose_c7OLD = Iso_logAccept_ROCs(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkDOCA_TTVA_loose_c7, CutAddSig_Default,
                              closeTrkDOCA_TTVA_loose_c7, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
ifilenameBkg2->Close();
...
grROC_TTVA_loose_c7OLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
...
void DOCA_logAccept_ROCs_v8_looseN(){
