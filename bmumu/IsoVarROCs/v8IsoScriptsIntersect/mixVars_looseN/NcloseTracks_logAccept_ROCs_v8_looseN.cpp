...
ColorIndex = 4;
TGraph* grROC_looseApprox = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
//////////////
ColorIndex = 2;
TGraph* grROC_looseTrkPerigee = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
                              closeTrkNtrksChi2_LooSiHi1Pt05_f2dc2_loose, CutAddSig_Default,
                              closeTrkNtrksChi2_LooSiHi1Pt05_f2dc2_loose, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
//////////////
ColorIndex = 1;
TGraph* grROC_TTVA_loose_c2NEW = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
//////////////
ColorIndex = 5;
TGraph* grROC_TTVA_loose_c2OLD = Iso_logAccept_ROCs_reverse(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkNtrks_TTVA_loose_c2, CutAddSig_Default,
                              closeTrkNtrks_TTVA_loose_c2, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
ifilenameBkg2->Close();
...
// grROC_TTVA_loose_c2NEW
// grROC_TTVA_loose_c2OLD
grROC_TTVA_loose_c2OLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_loose_c2OLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_loose_c2OLD->GetHistogram()->SetMinimum(ymin);  //   
grROC_TTVA_loose_c2OLD->Draw("al2");
grROC_TTVA_loose_c2NEW->Draw("same l2");
...
leg2->AddEntry(grROC_TTVA_loose_c2NEW, legName1,"l");
TString legName4 = mcName + " + "+ theYear + " BGM, old nTuple, from trks";
leg2->AddEntry(grROC_TTVA_loose_c2OLD, legName4,"l");
...
void NcloseTracks_logAccept_ROCs_v8_looseN(){
