...
ColorIndex = 1;
TGraphErrors* grROC_TTVA_looseNEW = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              B_Iso_TTVA_loose_dr, CutAddSig_TTVA_loose,
                              B_Iso_TTVA_loose_dr, CutAddBkg_TTVA_loose,
...
/////////////
TCut Weight_TTVA_loose2 = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
TCut CutAddSig_TTVA_loose2 = CutAdd*ExtraCut*PUcut;
TCut CutAddBkg_TTVA_loose2 = CutAdd*ExtraCut*PUcut;
ColorIndex = 5;
TGraphErrors* grROC_TTVA_looseOLD = Iso_ROCs(EvalTreeSig2, EvalTreeBkg2,
                              B_Iso_TTVA_loose_dr, CutAddSig_TTVA_loose2,
                              B_Iso_TTVA_loose_dr, CutAddBkg_TTVA_loose2,
                              Weight_TTVA_loose2, ColorIndex);
ifilenameBkg2->Close();
ifilenameSig2->Close();
...
// grROC_TTVA_looseNEW
// grROC_TTVA_looseOLD             
grROC_TTVA_looseOLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_looseOLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_looseOLD->GetHistogram()->SetMinimum(ymin);  //   Y
grROC_TTVA_looseOLD->Draw("al2");
grROC_TTVA_looseNEW->Draw("same l2");
// grROC_looseDerivation->Draw("same l2");
...
// TString legName1 = mcName + " + "+ theYear + " Loose TVA new nTuple, Derivation";
// leg2->AddEntry(grROC_looseDerivation, legName1,"l");
TString legName4 = mcName + " + "+ theYear + " BGJ approx., new nTuple from trks";
leg2->AddEntry(grROC_TTVA_looseNEW, legName4,"l");
TString legName3 = mcName + " + "+ theYear + " BGJ approx., old nTuple from trks";
leg2->AddEntry(grROC_TTVA_looseOLD, legName3,"l");
// TString legName5 = mcName + " + "+ runName + " Custom TVA old nTuple, from Trks";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_looseNi/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void Iso_MultiROCs_TTVA_v8_looseN(){
