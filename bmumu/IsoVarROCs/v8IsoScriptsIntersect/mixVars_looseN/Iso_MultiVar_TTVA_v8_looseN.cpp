...
ColorIndex = 2;
TH1F* h_looseDerivation = RetrieveHist(DirName, theYear, DataType, B_iso_10_noChi2_LooSiHi1Pt05_T0008388608, ColorIndex, FileDate, myPileup);
ColorIndex = 1;
TH1F* h_TTVA_loose_drNEW = RetrieveHist(DirName, theYear, DataType, B_Iso_TTVA_loose_dr, ColorIndex, FileDate, myPileup);
DirName  =  "/eos/home-a/agrummer/BsmumuData/FinalSkim/v6/";
ColorIndex = 5;
TH1F* h_TTVA_loose_drOLD = RetrieveHist(DirName, theYear, DataType, 
    B_Iso_TTVA_loose_dr, ColorIndex, "2019Dec5", myPileup);
...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    h_TTVA_loose_drOLD->GetYaxis()->SetNdivisions(4,5,0); //4,5,0
    h_TTVA_loose_drOLD->GetXaxis()->SetLabelOffset(0.028);
    h_TTVA_loose_drOLD->GetYaxis()->SetTitleSize(0.08);
    h_TTVA_loose_drOLD->GetYaxis()->SetTitleOffset(0.9);
    h_TTVA_loose_drOLD->GetYaxis()->SetLabelSize(0.08);
    ...
    if(DataType.EqualTo("data")){
        ...
        // h_TTVA_loose_drNEW
        // h_TTVA_loose_drOLD
        h_TTVA_loose_drOLD->SetMaximum(ymax);   // along          
        h_TTVA_loose_drOLD->SetMinimum(ymin);  //   Y  
        h_TTVA_loose_drOLD->Draw("e0p");
        h_TTVA_loose_drNEW->SetMarkerStyle(23);
        h_TTVA_loose_drNEW->Draw("e0psame");
        ...
        h_TTVA_loose_drOLD->SetMaximum(ymax);   // along          
        h_TTVA_loose_drOLD->SetMinimum(ymin);  //   Y  
        h_TTVA_loose_drOLD->SetMaximum(5.);
        h_TTVA_loose_drOLD->Draw("hist e0");
        h_TTVA_loose_drNEW->SetLineStyle(2);
        h_TTVA_loose_drNEW->Draw("hist e0 same");
...
// leg2->AddEntry(h_looseDerivation, "Loose TVA new nTuple, Derivation","pe");
// leg2->AddEntry(h_TTVA_loose_drNEW, "Loose TVA new nTuple, from Trks","pe");
leg2->AddEntry(h_TTVA_loose_drNEW, "BGJ approx., new nTuple from trks","pe");
// leg2->AddEntry(h_TTVA_loose_drOLD, "Loose TVA old nTuple, from Trks","pe");
leg2->AddEntry(h_TTVA_loose_drOLD, "BGJ approx., old nTuple from trks","pe");
}else if(DataType.EqualTo("mc")){
// if (!myPileup.EqualTo("high"))
// leg2->AddEntry(h_looseDerivation, "Loose TVA new nTuple, Derivation","l");
leg2->AddEntry(h_TTVA_loose_drNEW, "BGJ approx., new nTuple from trks","l");
leg2->AddEntry(h_TTVA_loose_drOLD, "BGJ approx., old nTuple from trks","l");
    }
// cout<<"DEBUG: 6"<<endl;
...
leg2->Draw();
    ...
    if (drawResiduals) {
        pad2->cd();
        hres = (TH1F*)h_TTVA_loose_drOLD->Clone("hres");
        hres->Sumw2();
        hres->Divide(h_TTVA_loose_drOLD,h_TTVA_loose_drNEW,1.0,1.0);
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Mar6_VarBinned_v8_mixVars_looseNi/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
delete c2;
delete h_looseDerivation;
delete h_TTVA_loose_drNEW;
delete h_TTVA_loose_drOLD;
// delete hRun1;
// delete h_1516;
// delete h_asRun1;
...
void Iso_MultiVar_TTVA_v8_looseN(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
