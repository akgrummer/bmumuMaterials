...
#include "/afs/cern.ch/user/a/agrummer/www/bmumu/IsoVarROCs/Iso_ROCs_Module_errors_Reverse.C"
...
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Jun6.root";//chi2<2 instead of <1
TCut PUcut = "";
...
TString dummyYear="";
TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_"+FileDate+".root";//chi2<2 instead of <1
...
if (theYear.EqualTo("2016main")){
 ...
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Jun6.root";//chi2<2 instead of <1
...
//////////////
ColorIndex = 1;
TGraph* grROC_TTVA_loose_c2NEW = Iso_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
//////////////
ColorIndex = 5;
TGraph* grROC_TTVA_loose_c2OLD = Iso_ROCs_reverse(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkNtrks_TTVA_loose_c2, CutAddSig_Default,
                              closeTrkNtrks_TTVA_loose_c2, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
ifilenameBkg2->Close();
...
void NcloseTracks_MultiROCs_TTVA_v8_looseN(){
