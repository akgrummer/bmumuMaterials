...
TGraph* grROC_1516 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              closeTrkDOCA_LooSiHi1Pt05_corc2cnt, CutAddSig_Default,
                              closeTrkDOCA_LooSiHi1Pt05_corc2cnt, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
/////////////
ColorIndex = 1;
TGraph* grROC_DefaultNEW = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
/////////////
ColorIndex = 3;
TGraph* grROC_DefaultOLD = Iso_ROCs(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkDOCA_comp, CutAddSig_Default,
                              closeTrkDOCA_comp, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
...
grROC_DefaultOLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c7->Draw("al2");
...
void DOCA_MultiROCs_TTVA_v8_1516N(){
