...
TGraph* grROC_1516 = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
                              closeTrkNtrksChi2_LooSiHi1Pt05_corc2cnt, CutAddSig_Default,
                              closeTrkNtrksChi2_LooSiHi1Pt05_corc2cnt, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
/////////////
ColorIndex = 1;
TGraph* grROC_DefaultNEW = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
//////////////
ColorIndex = 3;
TGraph* grROC_DefaultOLD = Iso_logAccept_ROCs_reverse(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkNtrks, CutAddSig_Default,
                              closeTrkNtrks, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
...
grROC_DefaultOLD->GetHistogram()->SetMinimum(ymin);  //   
...
TString legName2 = mcName + " + "+ theYear + " ACK, new nTuple, derivation";
leg2->AddEntry(grROC_DefaultNEW, legName2,"l");
// TString legName1 = mcName + " + "+ theYear + " As in 2015+2016 old nTuple, default";
TString legName1 = mcName + " + "+ theYear + " ACK, old nTuple, derivation";
...
void NcloseTracks_logAccept_ROCs_v8_1516N(){
