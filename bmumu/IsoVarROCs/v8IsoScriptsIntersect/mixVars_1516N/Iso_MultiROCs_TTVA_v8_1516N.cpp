...
grROC_DefaultOLD->GetHistogram()->SetMinimum(ymin);  //   Y
...
TString legName4 = mcName + " + "+ theYear + " ACH, new nTuple, derivation";
leg2->AddEntry(grROC_DefaultNEW, legName4,"l");
// TString legName3 = mcName + " + "+ theYear + " As in 2015+2016 old nTuple, default";
TString legName3 = mcName + " + "+ theYear + " ACH, old nTuple, derivation";
...
// TString legName2 = mcName + " + "+ theYear + " All tracks, chi2<5, new nTuple, derivation";
// leg2->AddEntry(grROC_all_c5NEW, legName2,"l");
// TString legName6 = mcName + " + "+ theYear + " All tracks, chi2<5, old nTuple, derivation";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_1516Ni/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void Iso_MultiROCs_TTVA_v8_1516N(){
