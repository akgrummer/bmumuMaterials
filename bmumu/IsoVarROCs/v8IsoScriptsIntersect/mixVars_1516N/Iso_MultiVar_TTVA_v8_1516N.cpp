...
leg2->AddEntry(h_DefaultNEW, "ACH, new nTuple, derivation","pe");
// leg2->AddEntry(h_DefaultOLD, "As in 2015+2016 old nTuple, default","pe");
leg2->AddEntry(h_DefaultOLD, "ACH, old nTuple, derivation","pe");
// leg2->AddEntry(h_asRun1, "As in Run 1, new nTuple, Derivation","pe");
// leg2->AddEntry(h_all_c5NEW, "All tracks, chi2<5, new nTuple, derivation","pe");
// leg2->AddEntry(h_all_c5OLD, "All tracks, chi2<5, old nTuple, derivation","pe");
}else if(DataType.EqualTo("mc")){
...
leg2->AddEntry(h_DefaultNEW, "ACH, new nTuple, derivation","l");
// leg2->AddEntry(h_DefaultOLD, "As in 2015+2016 old nTuple, default","l");
leg2->AddEntry(h_DefaultOLD, "ACH, old nTuple, derivation","l");
// leg2->AddEntry(h_asRun1, "As in Run 1, new nTuple, Derivation","l");
// leg2->AddEntry(h_all_c5NEW, "All tracks, chi2<5, new nTuple, derivation","l");
// leg2->AddEntry(h_all_c5OLD, "All tracks, chi2<5, old nTuple, derivation","l");
    }
// cout<<"DEBUG: 6"<<endl;
...
void Iso_MultiVar_TTVA_v8_1516N(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
