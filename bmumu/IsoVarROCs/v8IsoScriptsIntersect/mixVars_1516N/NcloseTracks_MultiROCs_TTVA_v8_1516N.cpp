...
/////////////
ColorIndex = 1;
TGraph* grROC_DefaultNEW = Iso_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
//////////////
ColorIndex = 3;
TGraph* grROC_DefaultOLD = Iso_ROCs_reverse(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkNtrks, CutAddSig_Default,
                              closeTrkNtrks, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
...
void NcloseTracks_MultiROCs_TTVA_v8_1516N(){
