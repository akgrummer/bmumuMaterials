...
#include "/afs/cern.ch/user/a/agrummer/www/bmumu/IsoVarROCs/Iso_logAccept_ROCs_errors.C"
...
TString dummyYear="";
TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_"+FileDate+".root";
...
// TCut CutAddBkg_TTVA_custom_dr = CutAdd*ExtraCut*PUcut;
ColorIndex = 1;
TGraphErrors* grROC_TTVA_custom_drNEW = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 5;
TGraphErrors* grROC_TTVA_custom_drOLD = Iso_logAccept_ROCs(EvalTreeSig2, EvalTreeBkg2,
...
grROC_TTVA_custom_drOLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
...
void Iso_MultiROCs_TTVA_logAccept_v8_customN(){
