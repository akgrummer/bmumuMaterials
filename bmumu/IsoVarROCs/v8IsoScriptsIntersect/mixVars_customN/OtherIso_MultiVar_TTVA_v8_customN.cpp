...
TCanvas* c2 = new TCanvas("c2", "Var Comps",0.,0., 800, 600);
    ...
    hdata_TTVA_customOLD->GetYaxis()->SetNdivisions(4,5,0); //4,5,0
    hdata_TTVA_customOLD->GetXaxis()->SetLabelOffset(0.028);
    hdata_TTVA_customOLD->GetYaxis()->SetTitleSize(0.08);
    hdata_TTVA_customOLD->GetYaxis()->SetTitleOffset(0.9);
    hdata_TTVA_customOLD->GetYaxis()->SetLabelSize(0.08);
...
// hdata_TTVA_customOLD
        ...
        hdata_TTVA_customNEW->SetMarkerStyle(23);
        ...
        hdata_TTVA_customNEW->SetLineStyle(2);
...
if(DataType.EqualTo("data")){
    ...
    if (theVar.EqualTo("DOCA")){
        ...
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, new nTuple, from trks","pe");
        leg2->AddEntry(hdata_TTVA_customOLD, "BFM, old nTuple, from trks","pe");
    }else{
        // leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee, new nTuple, Derivation","pe");
        // leg2->AddEntry(h_customApprox, "Custom TVA Approx., new nTuple, Derviation","pe");
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, new nTuple, from trks","pe");
...
//     BFM, old nTuple, from trks
// BFM, new nTuple, from trks
...
// Custom TVA Trk Perigee, new nTuple, Derivation
    ...
    if (theVar.EqualTo("DOCA")){
        ...
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, new nTuple, from trks","l");
        leg2->AddEntry(hdata_TTVA_customOLD, "BFM, old nTuple, from trks","l");
    }else{
        // leg2->AddEntry(h_customTrkPerigee, "Custom TVA Trk Perigee, new nTuple, Derivation","l");
        // leg2->AddEntry(h_customApprox, "Custom TVA Approx., new nTuple, Derviation","l");
        leg2->AddEntry(hdata_TTVA_customNEW, "BFM, new nTuple, from trks","l");
...
leg2->Draw();
    ...
    if (drawResiduals) {
        pad2->cd();
        hres = (TH1F*)hdata_TTVA_customOLD->Clone("hres");
        hres->Sumw2();
        hres->Divide(hdata_TTVA_customOLD,hdata_TTVA_customNEW,1.0,1.0);
...
void OtherIso_MultiVar_TTVA_v8_customN() {
