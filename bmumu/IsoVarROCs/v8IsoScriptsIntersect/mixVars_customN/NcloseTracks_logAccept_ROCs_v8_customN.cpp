...
// TGraph* grROC_1516 = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
///////1///////
ColorIndex = 4;
TGraph* grROC_customApprox = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
///////2///////
ColorIndex = 2;
TGraph* grROC_customTrkPerigee = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 1;
TGraph* grROC_TTVA_custom_c2NEW = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 5;
TGraph* grROC_TTVA_custom_c2OLD = Iso_logAccept_ROCs_reverse(EvalTreeSig2, EvalTreeBkg2,
                              closeTrkNtrks_TTVA_custom_c2, CutAddSig_Default,
                              closeTrkNtrks_TTVA_custom_c2, CutAddBkg_Default,
                              Weight_Default, ColorIndex);
ifilenameBkg2->Close();
...
grROC_TTVA_custom_c2OLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_custom_c2OLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_custom_c2OLD->GetHistogram()->SetMinimum(ymin);  //   
grROC_TTVA_custom_c2OLD->Draw("al2");
grROC_TTVA_custom_c2NEW->Draw("same l2");
...
//     }
TString legName1 = mcName + " + "+ theYear + " BFM, new nTuple, from trks";
leg2->AddEntry(grROC_TTVA_custom_c2NEW, legName1,"l");
TString legName4 = mcName + " + "+ theYear + " BFM, old nTuple, from trks";
leg2->AddEntry(grROC_TTVA_custom_c2OLD, legName4,"l");
...
void NcloseTracks_logAccept_ROCs_v8_customN(){
