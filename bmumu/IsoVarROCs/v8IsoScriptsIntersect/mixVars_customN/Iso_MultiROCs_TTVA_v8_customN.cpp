...
#include "/afs/cern.ch/user/a/agrummer/www/bmumu/IsoVarROCs/Iso_ROCs_Module_errors.C"
...
// TString filenameSig_Run1 = DirName + "MC16aAllcommon/LASTskim_MC16a_All_Studies_2019Apr24.root";
...
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019May30.root";
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Jun3.root";
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Jun5.root";
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Jun6.root";
// TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Jun12.root";//chi2<6 in TTVAs
TCut PUcut = "";
...
TString dummyYear="";
TString filenameBkg = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_"+FileDate+".root";//chi2<6 in TTVAs
if (theYear.Contains("2016")){ dummyYear =theYear; theYear = "2016"; }
TString filenameBkg2 = DirName2 + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019Dec5.root";//chi2<6 in TTVAs
...
if (theYear.EqualTo("2016main")){
 ...
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019May30.root";
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Jun3.root";
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Jun5.root";
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Jun6.root";
 // filenameSig = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Jun6.root";//chi2<6 in TTVAs
 filenameSig = DirNameSig + mcName+"Allcommon/LASTskim_"+mcName+"_All_"+FileDate+".root";
TString filenameSig2 = DirName2 + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019Dec5.root";
...
ColorIndex = 4;
TGraphErrors* grROC_custom_approx = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 2;
TGraphErrors* grROC_customDerivation = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
// TCut CutAddBkg_TTVA_custom_dr = CutAdd*ExtraCut*PUcut;
ColorIndex = 1;
TGraphErrors* grROC_TTVA_custom_drNEW = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              B_Iso_TTVA_custom_dr, CutAddSig_TTVA_custom_dr,
                              B_Iso_TTVA_custom_dr, CutAddBkg_TTVA_custom_dr,
                              Weight_TTVA_custom_dr, ColorIndex);
///////////////
// //comment because it is the same as the above anyway.
// // TCut Weight_all_c5_2 = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
// // TCut CutAddSig_all_c5_2 = CutAdd*ExtraCut*PUcut;
// // TCut CutAddBkg_all_c5_2 = CutAdd*ExtraCut*PUcut;
// ColorIndex = 5;
// TGraphErrors* grROC_looseDerivation = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
...
///////////
TCut Weight_TTVA_custom_dr2 = "PVWeights*Muon1_reco_eff_sf*Muon2_reco_eff_sf";
TCut CutAddSig_TTVA_custom_dr2 = CutAdd*ExtraCut*PUcut;
TCut CutAddBkg_TTVA_custom_dr2 = CutAdd*ExtraCut*PUcut;
ColorIndex = 5;
TGraphErrors* grROC_TTVA_custom_drOLD = Iso_ROCs(EvalTreeSig2, EvalTreeBkg2,
                              B_Iso_TTVA_custom_dr, CutAddSig_TTVA_custom_dr2,
                              B_Iso_TTVA_custom_dr, CutAddBkg_TTVA_custom_dr2,
                              Weight_TTVA_custom_dr2, ColorIndex);
ifilenameBkg2->Close();
ifilenameSig2->Close();

// //new file
// TString filenameBkg_DR_1 = DirName + theYear+"Allcommon/LASTskim_"+theYear+"_All_2019July2.root";//chi2<6 in TTVAs
// TString filenameSig_DR_1 = DirName + mcName+"Allcommon/LASTskim_"+mcName+"_All_2019July2.root";
...
// grROC_custom_approx
// grROC_customDerivation
// grROC_TTVA_custom_drNEW
// grROC_TTVA_custom_drOLD              
grROC_TTVA_custom_drOLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_custom_drOLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_custom_drOLD->GetHistogram()->SetMinimum(ymin);  //   Y
grROC_TTVA_custom_drOLD->Draw("al2");
grROC_TTVA_custom_drNEW->Draw("same l2");
...
// grROC_TTVA_custom_drNEW
// grROC_TTVA_custom_drOLD 
// TString legName1 = mcName + " + "+ theYear + " Custom TVA Trk Perigee, new nTuple, Derivation";
// leg2->AddEntry(grROC_customDerivation, legName1,"l");
// TString legName4 = mcName + " + "+ theYear + " Custom TVA Approx., new nTuple, Derviation";
// leg2->AddEntry(grROC_custom_approx, legName4,"l");
TString legName3 = mcName + " + "+ theYear + " BFJ, new nTuple, from trks";
leg2->AddEntry(grROC_TTVA_custom_drNEW, legName3,"l");
TString legName5 = mcName + " + "+ theYear + " BFJ, old nTuple, from trks";
leg2->AddEntry(grROC_TTVA_custom_drOLD, legName5,"l");
// TString legName2 = mcName + " + "+ runName + " As in Run 1";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_customNi/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void Iso_MultiROCs_TTVA_v8_customN(){
