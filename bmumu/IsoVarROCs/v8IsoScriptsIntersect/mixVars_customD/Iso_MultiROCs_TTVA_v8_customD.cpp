...
grROC_TTVA_custom_drNEW->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_custom_drNEW->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_custom_drNEW->GetHistogram()->SetMinimum(ymin);  //   Y
// grROC_TTVA_custom_drOLD->Draw("al2");
grROC_TTVA_custom_drNEW->Draw("al2");
...
// grROC_TTVA_custom_drNEW
// grROC_TTVA_custom_drOLD 
TString legName1 = mcName + " + "+ theYear + " BEJ, derivation";
leg2->AddEntry(grROC_customDerivation, legName1,"l");
TString legName4 = mcName + " + "+ theYear + " BFJ, derivation";
leg2->AddEntry(grROC_custom_approx, legName4,"l");
TString legName3 = mcName + " + "+ theYear + " BFJ, from trks";
leg2->AddEntry(grROC_TTVA_custom_drNEW, legName3,"l");
// TString legName5 = mcName + " + "+ theYear + " Custom TVA old nTuple, from Trks";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Feb19_v8_mixVars_customD/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void Iso_MultiROCs_TTVA_v8_customD(){
