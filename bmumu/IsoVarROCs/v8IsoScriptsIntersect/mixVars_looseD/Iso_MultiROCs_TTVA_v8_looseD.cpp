...
// grROC_TTVA_looseNEW
// grROC_TTVA_looseOLD             
grROC_TTVA_looseNEW->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_looseNEW->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_looseNEW->GetHistogram()->SetMinimum(ymin);  //   Y
// grROC_TTVA_looseOLD->Draw("al2");
grROC_TTVA_looseNEW->Draw("al2");
...
TString legName1 = mcName + " + "+ theYear + " BGJ, derivation";
leg2->AddEntry(grROC_looseDerivation, legName1,"l");
// TString legName4 = mcName + " + "+ theYear + " Loose TVA new nTuple, from Trks";
TString legName4 = mcName + " + "+ theYear + " BGJ approx., from trks";
leg2->AddEntry(grROC_TTVA_looseNEW, legName4,"l");
// TString legName3 = mcName + " + "+ theYear + " Loose TVA old nTuple, from Trks";
...
void Iso_MultiROCs_TTVA_v8_looseD(){
