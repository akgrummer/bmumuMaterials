...
grROC_TTVA_loose_c2NEW->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_TTVA_loose_c2NEW->GetHistogram()->SetMaximum(ymax);   // along          
grROC_TTVA_loose_c2NEW->GetHistogram()->SetMinimum(ymin);  //   
// grROC_TTVA_loose_c2OLD->Draw("al2");
grROC_TTVA_loose_c2NEW->Draw("al2");
...
void NcloseTracks_logAccept_ROCs_v8_looseD(){
