...
ColorIndex = 0;
TH1F* h_asRun1 = RetrieveHist(DirName, theYear, DataType, B_iso_7_Chi2_5_LooSiHi1Pt05_T0000000127, ColorIndex, FileDate, myPileup);
ColorIndex = 2;
TH1F* h_1516 = RetrieveHist(DirName, theYear, DataType, B_iso_7_Chi2_5_LooSiHi1Pt05, ColorIndex, FileDate, myPileup);
ColorIndex = 1;
...
c2->SaveAs(OutdirName + "Figures/VarComps2020Feb19_VarBinned_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".pdf");
// c2->SaveAs(OutdirName + "Figures/VarComps2020Feb19_VarBinned_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/VarComp_"+Tag+".png");
delete c2;
delete h_asRun1;
delete h_1516;
delete h_DefaultNEW;
