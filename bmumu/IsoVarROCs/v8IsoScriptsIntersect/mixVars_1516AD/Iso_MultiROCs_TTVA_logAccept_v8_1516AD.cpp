...
c2->SaveAs(OutdirName + "Figures/ROC_2020Feb19_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
// c2->SaveAs(OutdirName + "Figures/ROC_2020Feb19_v8_mixVars_1516AD/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".png");
