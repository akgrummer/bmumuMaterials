...
// TCut CutAddBkg_Default = CutAdd*ExtraCut*PUcut;
ColorIndex = 1;
TGraphErrors* grROC_DefaultNEW = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 5;
TGraphErrors* grROC_all_c5NEW = Iso_logAccept_ROCs(EvalTreeSig, EvalTreeBkg,
...
ColorIndex = 3;
TGraphErrors* grROC_DefaultOLD = Iso_logAccept_ROCs(EvalTreeSig2, EvalTreeBkg2,
...
ColorIndex = 4;
TGraphErrors* grROC_all_c5OLD = Iso_logAccept_ROCs(EvalTreeSig2, EvalTreeBkg2,
...
grROC_all_c5OLD->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
...
void Iso_MultiROCs_TTVA_logAccept_v8_1516AN(){
