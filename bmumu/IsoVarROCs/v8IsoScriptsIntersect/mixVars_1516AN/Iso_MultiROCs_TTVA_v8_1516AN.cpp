...
TGraphErrors* grROC_1516 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05, CutAddSig_Default,
                              B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05, CutAddBkg_Default,
...
// grROC_DefaultOLD
// grROC_all_c5OLD
grROC_all_c5OLD->GetXaxis()->SetLimits(xmin, xmax);// along X
grROC_all_c5OLD->GetHistogram()->SetMaximum(ymax);   // along          
grROC_all_c5OLD->GetHistogram()->SetMinimum(ymin);  //   Y
...
//  All tracks, chi2<5, new nTuple
//  All tracks, chi2<5, old nTuple
...
// TString legName2 = mcName + " + "+ theYear + " All tracks, chi2<5, new nTuple";
TString legName2 = mcName + " + "+ theYear + " BDI, new nTuple, from trks";
leg2->AddEntry(grROC_all_c5NEW, legName2,"l");
// TString legName6 = mcName + " + "+ theYear + " All tracks, chi2<5, old nTuple";
TString legName6 = mcName + " + "+ theYear + " BDI, old nTuple, from trks";
...
c2->SaveAs(OutdirName + "Figures/ROC_2020Mar6_v8_mixVars_1516ANi/"+varDir+"/"+typeDir+"/ROC_"+Tag+ExtraCut+".pdf");
...
void Iso_MultiROCs_TTVA_v8_1516AN(){
