...
ColorIndex = 1;
TGraph* grROC_TTVA_tight_c7 = Iso_logAccept_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
...
grROC_TTVA_tight_c7->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_tight_c1->Draw("al2");
