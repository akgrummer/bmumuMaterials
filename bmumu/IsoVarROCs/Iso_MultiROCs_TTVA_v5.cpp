...
if(theVar.EqualTo("nCloseTrks")){
    grROC = Iso_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                  myVar, CutAddSig,
                  myVar, CutAddBkg,
                  myWeight, ColorIndex);
}else{
    grROC = Iso_ROCs(EvalTreeSig_2016, EvalTreeBkg_2016,
                  myVar, CutAddSig,
                  myVar, CutAddBkg,
                  myWeight, ColorIndex);
}
...
TGraphErrors* grROC(NULL);
if(theVar.EqualTo("nCloseTrks")){
    grROC = Iso_ROCs_reverse(EvalTreeSig_Run1, EvalTreeBkg_Run1,
                  myVar, PUcut*CutRun1,
                  myVar, PUcut*CutRun1,
                  run1Weight, ColorIndex);
}else{
    grROC = Iso_ROCs(EvalTreeSig_Run1, EvalTreeBkg_Run1,
                  myVar, PUcut*CutRun1,
                  myVar, PUcut*CutRun1,
                  run1Weight, ColorIndex);
}
...
// FileDate = "2019July17"; //ID hits like run 1 (without IBL)
    ...
    myVar = Run1iso;
    Run1set = true;
    makeROCplots("ROC", whichVar, FileDate, 
