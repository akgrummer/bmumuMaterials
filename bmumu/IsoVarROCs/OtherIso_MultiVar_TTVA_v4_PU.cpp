...
ColorIndex = 1;
h2016data_TTVA_custom_c1 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_custom_c1_80, ColorIndex, FileDate, myPileup);
ColorIndex = 2;
h2016data_TTVA_custom_c2 = RetrieveHist(theYear, DataType, closeTrkNtrks_TTVA_custom_c2_80, ColorIndex, FileDate, myPileup);
ColorIndex = 4;
...
ColorIndex = 0;
h2016data_Default = RetrieveHist(theYear, DataType, closeTrkDOCA, ColorIndex, FileDate, myPileup);
ColorIndex = 1;
h2016data_TTVA_custom_c1 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_custom_c7, ColorIndex, FileDate, myPileup);
ColorIndex = 2;
h2016data_TTVA_custom_c2 = RetrieveHist(theYear, DataType, closeTrkDOCA_TTVA_custom_c2, ColorIndex, FileDate, myPileup);
ColorIndex = 4;
...
void OtherIso_MultiVar_TTVA_v4_PU() {
