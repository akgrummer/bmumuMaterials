...
ColorIndex = 0;
TGraph* grROC_2016_Default = Iso_logAccept_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 1;
TGraph* grROC_TTVA_custom_c1 = Iso_logAccept_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 2;
TGraph* grROC_TTVA_custom_c2 = Iso_logAccept_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
...
ColorIndex = 4;
TGraph* grROC_2016_all_c1 = Iso_logAccept_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
                              closeTrkNtrks_all_c1, CutAddSig_2016_Default,
                              closeTrkNtrks_all_c1, CutAddBkg_2016_Default,
                              Weight_2016_Default, ColorIndex);
///////4////////closeTrkNtrks_all_c2
ColorIndex = 5;
TGraph* grROC_2016_all_c2 = Iso_logAccept_ROCs_reverse(EvalTreeSig_2016, EvalTreeBkg_2016,
...
grROC_2016_all_c2->GetHistogram()->SetMinimum(ymin);  //   YgrROC_TTVA_custom_c1->Draw("al2");
grROC_2016_all_c2->Draw("al2");
grROC_TTVA_custom_c1->Draw("same l2");
...
void NcloseTracks_logAccept_ROCs_v4(){
