...
#for lxplus
export HOME_DIR=/afs/cern.ch/user/a/agrummer/www/bmumu2020
# export WORK_DIR=${HOME_DIR}/www/bmumu/myMVA
export WORK_DIR=${HOME_DIR}/BDT
# export WORK_DIR=/home/agrummer/myTraining
export OUTMVA=/eos/home-a/agrummer/BsmumuData/BDToutput
...
export Output_DIR=${OUTMVA}/2020May20
...
mkdir -p ${Output_DIR}/${outdname}
export OUTDIR=${outdname}
...
echo ${myArgs}
root -l -q ''${WORK_DIR}'/runMVA_pc01.cxx('\"${OUTDIR}\"', '${myArgs}')' >> ${Output_DIR}/${outdname}/output.txt 2>>${Output_DIR}/${outdname}/err.txt
