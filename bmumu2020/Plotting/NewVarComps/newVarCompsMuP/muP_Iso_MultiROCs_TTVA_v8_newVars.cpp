...
#include "/afs/cern.ch/user/a/agrummer/www/bmumu2020/Plotting/NewVarComps/Iso_ROCs_Module_errors.C"
...
TString filenameBkg = DirName + "LASTskim.user.agrummer.Data1516.merged.root";//chi2<6 in TTVAs
TString filenameSig("");
TString mcName("");
TString runName("");
TCut RunNumberCut("");
...
TGraphErrors* grROC_1516 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              muPisolation, CutAddSig_Default,
                              muPisolation, CutAddBkg_Default,
...
TGraphErrors* grROC_asRun1 = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              muP_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127, CutAddSig_TTVA_loose,
                              muP_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127, CutAddBkg_TTVA_loose,
...
//                               muP_iso_10_noChi2_LooSiHi1Pt05_T0004194304, CutAddSig_TTVA_custom_dr,
//                               muP_iso_10_noChi2_LooSiHi1Pt05_T0004194304, CutAddBkg_TTVA_custom_dr,
...
TGraphErrors* grROC_customDerivation = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              muP_iso_10_noChi2_LooSiHi1Pt05_T0134217728, CutAddSig_all_c5,
                              muP_iso_10_noChi2_LooSiHi1Pt05_T0134217728, CutAddBkg_all_c5,
...
TGraphErrors* grROC_looseDerivation = Iso_ROCs(EvalTreeSig, EvalTreeBkg,
                              muP_iso_10_noChi2_LooSiHi1Pt05_T0008388608, CutAddSig_all_c5,
                              muP_iso_10_noChi2_LooSiHi1Pt05_T0008388608, CutAddBkg_all_c5,
                              Weight_all_c5, ColorIndex);
ifilenameBkg->Close();
ifilenameSig->Close();
// //new file
...
//                               muP_Iso_TTVA_custom, CutAddSig_TTVA_custom_dr,
//                               muP_Iso_TTVA_custom, CutAddBkg_TTVA_custom_dr,
//                               Weight_TTVA_custom_dr, ColorIndex);
...
//                               muP_Iso_all_c5, CutAddSig_all_c5_dr,
//                               muP_Iso_all_c5, CutAddBkg_all_c5_dr,
...
grROC_looseDerivation->GetHistogram()->SetMinimum(ymin);  //   Y
...
leg2->SetHeader("muP Isolation "+PileupHeader+ExtraCut);
...
void muP_Iso_MultiROCs_TTVA_v8_newVars(){
