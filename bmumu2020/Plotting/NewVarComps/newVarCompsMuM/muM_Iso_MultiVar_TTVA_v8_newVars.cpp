...
// muM_Iso_all_c6
//
// muM_Iso_Ntracks_TTVA_custom
// muM_Iso_Ntracks_all_c5
// muM_Iso_Ntracks_all_c6
Int_t ColorIndex(0);
ColorIndex = 3;
TH1F* hRun1 = RetrieveHistRun1(DataType, Run1muMiso, ColorIndex, myPileup);
ColorIndex = 0;
// TH1F* h2016data_Default = RetrieveHist(theYear, DataType, Bisolation, ColorIndex, FileDate, myPileup);
TH1F* h_1516 = RetrieveHist(theYear, DataType, muMisolation, ColorIndex, FileDate, myPileup);
ColorIndex = 1;
TH1F* h_asRun1 = RetrieveHist(theYear, DataType, muM_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127, ColorIndex, FileDate, myPileup);
// ColorIndex = 4;
// TH1F* h_custom_approx = RetrieveHist(theYear, DataType, muM_iso_10_noChi2_LooSiHi1Pt05_T0004194304, ColorIndex, FileDate, myPileup);
ColorIndex = 2;
TH1F* h_customDerivation = RetrieveHist(theYear, DataType, muM_iso_10_noChi2_LooSiHi1Pt05_T0134217728, ColorIndex, FileDate, myPileup);
ColorIndex = 5;
TH1F* h_looseDerivation = RetrieveHist(theYear, DataType, muM_iso_10_noChi2_LooSiHi1Pt05_T0008388608, ColorIndex, FileDate, myPileup);
...
void muM_Iso_MultiVar_TTVA_v8_newVars(){
    TString FileDate = "";
    // FileDate = "2019July30";
    // FileDate = "2019Nov21";
    // FileDate = "2019Dec5";
