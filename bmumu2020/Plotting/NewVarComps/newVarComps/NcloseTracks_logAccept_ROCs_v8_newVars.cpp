...
#include "/afs/cern.ch/user/a/agrummer/www/bmumu2020/Plotting/NewVarComps/Iso_logAccept_ROCs_errors_Reverse.C"
...
TGraph* grROC_1516 = Iso_logAccept_ROCs_reverse(EvalTreeSig, EvalTreeBkg,
                              closeTrkNtrks_80, CutAddSig_Default,
                              closeTrkNtrks_80, CutAddBkg_Default,
...
grROC_1516->GetHistogram()->SetMinimum(ymin);  //   
