...
// root -l -q addClassBDT_2020.C"(\"/afs/cern.ch/user/a/agrummer/WorkSpace/BsmumuData/SidebandTrained/LASTskim.mc16Bs.root\")"
...
void addClassBDT_2020(TString fname = "", TString config = ""){
  //=============================================
  ...
  bool isData(false);
  if (fname.Contains("Data1516")) isData = true;
  ...
  // TString idir = "/afs/cern.ch/user/a/agrummer/www/bmumu2020/BDT/BDToutput/2020Jun26/";
  TString idir = "/home/agrummer/bmumu2020/BDT/BDToutput/2020Jun16/";
  // TString idir = "/home/agrummer/bmumu2020/BDT/BDToutput/2020Jun26/";
  // TString idir = "/home/agrummer/bmumu2020/BDT/BDToutput/2020July16/";
  // TString idir = "/home/agrummer/bmumu2020/BDT/BDToutput/2020July22/";
  TString idir4 = "/home/agrummer/bmumu2020/BDT/BDToutput/2020Aug6/";


  TString isoName = "B_iso_7_Chi2_5_LoosePt05";
  TString docaName = "closeTrkDOCA_3";
  TString ncloseTrksName = "closeTrkNtrksChi2";
  if (config.EqualTo("out_Custom")){
    isoName = "B_iso_10_noChi2_LooSiHi1Pt05_T0134217728";
    docaName = "closeTrkDOCA_T0134217728_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0134217728_LooSiHi1Pt05_f2dc2";
  }
  if (config.EqualTo("out_Loose")){
    isoName = "B_iso_10_noChi2_LooSiHi1Pt05_T0008388608";
    docaName = "closeTrkDOCA_T0008388608_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0008388608_LooSiHi1Pt05_f2dc2";
  }
  if (config.EqualTo("out_Run1")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("out_Run1privxmu")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("out_Run1nPV")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("out_BestSep")){
    isoName = "B_iso_10_noChi2_LooSiHi1Pt05_T0008388608";
    docaName = "closeTrkDOCA_T0134217728_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0134217728_LooSiHi1Pt05_f2dc2";
  }
  if (config.EqualTo("out_Run1Custom")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_T0134217728_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0134217728_LooSiHi1Pt05_f2dc2";
  }
  if (config.EqualTo("out_Run1privxmu_round")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("out_Run1nPV_npvweights")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("out_Run1_npvweights")){
    isoName = "B_iso_7_Chi2_5_noAbs_LooSiHi1Pt05_T0000000127";
    docaName = "closeTrkDOCA_3";
    ncloseTrksName = "closeTrkNtrksChi2";
  }
  if (config.EqualTo("Custom_privxmu")){
    idir=idir4;
    isoName = "B_iso_10_noChi2_LooSiHi1Pt05_T0134217728";
    docaName = "closeTrkDOCA_T0134217728_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0134217728_LooSiHi1Pt05_f2dc2";
  }
  if (config.EqualTo("Custom_nPV")){
    idir=idir4;
    isoName = "B_iso_10_noChi2_LooSiHi1Pt05_T0134217728";
    docaName = "closeTrkDOCA_T0134217728_LooSiHi1Pt05_f2dc2";
    ncloseTrksName = "closeTrkNtrksChi2_T0134217728_LooSiHi1Pt05_f2dc2";
...
//XML variable names:
  ...
  reader->AddVariable( "Bvtx3DIP", &IP3D_reader );
  reader->AddVariable( "B_minChi2MuonsIPtoAnyPV", &Chi2Muons2AnyPV_reader );
  if (config.EqualTo("out_Run1nPV")||config.EqualTo("Custom_nPV")) reader->AddVariable( "Npv", &Npv_reader );
  if (config.EqualTo("out_Run1nPV_npvweights")) reader->AddVariable( "Npv", &Npv_reader );
  // if (config.EqualTo("out_Run1privxmu")) reader->AddVariable( "PRIVX_mu", &PRIVX_mu_reader );
  if (config.EqualTo("out_Run1privxmu_round")||config.EqualTo("Custom_privxmu")) reader->AddVariable( "PRIVX_mu_round", &PRIVX_mu_reader );
  ...
  if (tname.EqualTo("T_mv")) {
    ...
    */
    ...
    intree->SetBranchStatus("PRIVX_mu_round",1);
    intree->SetBranchAddress("PRIVX_mu_round", &PRIVX_mu_round );
    ...
    intree->SetBranchStatus("NPVweight",1); //Pileup weights
  ...
  for (Long64_t ievt=0; ievt<intree->GetEntries();ievt++) {
    ...
    if (isData) {if (!(B_MUCALC_mass>5526.0 && B_MUCALC_mass<=5966.0)) continue;}
    ...
    if (config.EqualTo("out_Run1nPV")||config.EqualTo("Custom_nPV")) Npv_reader= (float) Npv;
    if (config.EqualTo("out_Run1nPV_npvweights")) Npv_reader= (float) Npv;
    // if (config.EqualTo("out_Run1privxmu")) PRIVX_mu_reader=PRIVX_mu;
    if (config.EqualTo("out_Run1privxmu_round")||config.EqualTo("Custom_privxmu")) PRIVX_mu_reader=PRIVX_mu_round;
