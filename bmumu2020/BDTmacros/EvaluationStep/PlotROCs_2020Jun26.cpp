...
TString dirName2 = idir2+"out_Run1Custom/";
TString dirName3 = idir+"out_Run1/";
TString dirName4 = idir2+"out_BestSep/";
...
leg->AddEntry(graph5, "As in Run 1 B Iso and as in Run 2 closeTrk Vars" ,"l");
leg->AddEntry(graph2, "As in Run 1 B Iso and Custom TVA closeTrk Vars " ,"l");
leg->AddEntry(graph4, "Loose TVA B Iso and Custom TVA closeTrk Vars " ,"l");
...
c2->SaveAs(idir2+"ROC_BestSepComparisons.pdf");
