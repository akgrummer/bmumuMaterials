// MultiROC_wRun1_LogAccept.cpp
// Author: Aidan G
// 
// Code takes input root graphs and plots them on the 
...
TString dirName1 = "/afs/cern.ch/user/a/agrummer/www/bmumu/OutMVA/EvalFolder2/"+DateName1+"/";
...
TString dirName2 = "/afs/cern.ch/user/a/agrummer/www/bmumu/OutMVA/EvalFolder2/"+DateName2+"/";

// TString DateName3 = "Jun11_SidebandTrained/eval3";
TString DateName3 = "Jun12_SidebandTrained/BDT3";
TString dirName3 = "/afs/cern.ch/user/a/agrummer/www/bmumu/OutMVA/EvalFolder2/"+DateName3+"/";
...
TString vBDT2 = "";
TString vBDT3 = "";
TString idirNew = "/afs/cern.ch/user/a/agrummer/www/bmumu2020/BDT/BDToutput/2020Jun16/";
TString dirNameNew = idirNew+"out_Custom/";
// TString dirNameNew = idirNew+"out_Run1/";
...
myfilenames.push_back(dirNameNew +"/EvalROC.root");
...
//ifilename2 ifilename4 should not be plotted in the case for the combined Run 2 BDT 
TFile* ifilename1 = new TFile(myfilenames[0]);
TFile* ifilename2 = new TFile(myfilenames[1]);
TFile* ifilename3 = new TFile("/afs/cern.ch/user/a/agrummer/www/bmumu/Data/rocsS1.root");
...
// leg->AddEntry(graph1, "Run 2 BDT","f");
// leg->AddEntry(graph2, "Run 2 new nTuples (As in Run 1 B Iso)" ,"f");
leg->AddEntry(graph2, "Run 2 new nTuples (Custom Iso Vars)" ,"f");
leg->AddEntry(graph1, "partial Run 2 (old nTuples)","f");
...
c2->SaveAs(dirNameNew+"MultiROC_wRun1_LogAccept2020Jun19.pdf");
