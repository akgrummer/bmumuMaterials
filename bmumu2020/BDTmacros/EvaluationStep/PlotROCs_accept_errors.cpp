...
myfilenames.push_back(dirName4 +"EvalROC_accept_error.root");
...
TFile* ifilename1 = new TFile(myfilenames[3]);
...
leg->AddEntry(graph5, "Run 1 B Iso + Run 2 closeTrk no PU" ,"l");
leg->AddEntry(graph1, "Custom TVA Iso Vars no PU" ,"l");
// leg->AddEntry(graph2, "With PRIVX mu Variable" ,"l");
leg->AddEntry(graph2, "Run 1 B Iso + Run 2 closeTrk + PRIVX mu (rounded)" ,"l");
...
c2->SaveAs(idir3+"ROC_Run1PUtrained_2020Aug6.pdf");
