...
for(int i = 0; i<NumberOfBinsROC; i++){
  ...
  if ((SigTestEff[i] > 0.1795 && SigTestEff[i] < 0.1805) || (SigTestEff[i] > 0.3595 && SigTestEff[i] < 0.3605) || (SigTestEff[i] > 0.5395 && SigTestEff[i] < 0.5405)){
