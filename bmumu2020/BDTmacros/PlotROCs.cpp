...
TString dirNameRun1 = "/Users/agrummer/cernbox/www/bmumu/OutMVA/EvalFolder2/";
TString idir = "/Users/agrummer/cernbox/www/bmumu2020/BDT/BDToutput/2020May20/";
TString dirName1 = idir+"out_Custom/";
TString dirName2 = idir+"out_Loose/";
TString dirName3 = idir+"out_Run1/";
TString dirName4 = idir+"out_Nom/";
// myfilenames.push_back(dirName +"ROC_15vars.root");
// myfilenames.push_back(dirName +"ROC_7vars_2.root");
myfilenames.push_back(dirName1 +"ROC.root");
myfilenames.push_back(dirName2 +"ROC.root");
myfilenames.push_back(dirName3 +"ROC.root");
myfilenames.push_back(dirName4 +"ROC.root");
...
TFile* ifilename4 = new TFile(myfilenames[3]);
...
graph4->SetLineColor(kMagenta);//kBlack
graph4->SetFillColor(kMagenta);//kBlack
graph4->SetLineWidth(1);
graph4->SetMarkerStyle(32);
graph4->SetMarkerColor(kMagenta);//kBlack
...
leg->AddEntry(graph1, "Custom Iso Vars","pl");
leg->AddEntry(graph2, "Loose Iso Vars" ,"pl");
leg->AddEntry(graph5, "As in Run 1 B Iso and as in Run 2 closeTrk Vars" ,"pl");
leg->AddEntry(graph4, "As in Run 2 Iso Vars" ,"pl");
