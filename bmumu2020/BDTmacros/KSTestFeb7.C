#include<TMath.h>
// #include "/home/agrummer/bmumu2020/ATLAS"
...
// TString RootDirName = "out2";
// TString filename = FilePath + RootDirName + "/"+"bdt2016test.root";
...
// void KSTestFeb7(TString DirName = "/home/agrummer/www/bmumu/myMVA/", TString MaxDepth = "2", TString MinNodeSize = "0.1", TString AdaBoostBeta= "0.5", TString NTrees = "500"){
void KSTestFeb7(TString DirName = "/home/agrummer/bmumu2020/BDT/", TString RootDirName = "Nom"){
SetAtlasStyle();
// TString FilePath = "/Users/agrummer/cernbox/www/bmumu/myMVA/";
// TString RootDirName = "out2";
// TString DirName = "OutputMVAMar8/";
// TString RootDirName = "out_MaxDepth"+MaxDepth+"_MinNodeSize"+MinNodeSize+"_AdaBoostBeta"+AdaBoostBeta+"_NTrees"+NTrees;
RootDirName = "BDToutput/2020May20/out_"+RootDirName;
TString filename = DirName + RootDirName + "/"+"bdt2020.root";

TFile* ifilename = new TFile(filename);

// ifilename->cd("out/");
// TTree *TestTree = gROOT->FindTree("TrainTree");
TTree *TestTree = (TTree*)ifilename->Get(RootDirName + "/TestTree");
TTree *TrainTree = (TTree*)ifilename->Get(RootDirName + "/TrainTree");
// .ls
...
c2->Update();
c1->SaveAs(DirName + RootDirName+"/KS.pdf");
c2->SaveAs(DirName + RootDirName+"/ROC.pdf");
ofstream ofileVals (DirName + RootDirName+ "/ROCandKSvals.csv", ofstream::out);
...
ofileVals <<"ROC18,"<<"ROC36,"<<"ROC54," <<"KSvalSig,"<< "KSvalBkg" <<endl;
ofileVals <<sig18<<","<<sig36<<","<<sig54<<","<<kolS_ROCbins<< ","<< kolB_ROCbins <<endl;
ofileVals.close();

TFile ofile(DirName + RootDirName+ "/ROC.root", "recreate");
grROC->Write();
