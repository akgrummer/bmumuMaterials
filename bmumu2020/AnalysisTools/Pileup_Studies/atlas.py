...
ROOT.gStyle.SetPalette(1) #THIS WAS ADDED TO ATLAS STYLE TO VISUALIZE COLORS CORRECTLY
...
ROOT.gStyle.SetPadRightMargin(0.08)#THIS WAS 0.05 BUT LABELS IN EXPONENTIAL NOTATION CANNOT BE SEEN IN THIS WAY
