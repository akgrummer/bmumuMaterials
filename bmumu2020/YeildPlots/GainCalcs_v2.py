...
import collections
# for only 1 gain:
# gROOT.LoadMacro( "/Users/agrummer/cernbox/www/bmumu2020/YeildPlots/MakeATGraph.C" )
# comparing new to old:
gROOT.LoadMacro( "/Users/agrummer/cernbox/www/bmumu2020/YeildPlots/MakeATGraphNewOld.C" )
...
for Year in d:
  ...
  dfNew = pd.read_csv("/Users/agrummer/cernbox/www/bmumu2020/YeildPlots/Triggers/BphysTriggers"+Year[:4]+".csv", index_col=0)
  for Period in d[Year]:
    ...
    d[Year][Period] = dict.fromkeys([" Prescale Corrected"," LAr Corrected", " LRecorded", "Events", "Gain", "NewLumi"])
    if Period =="D" and "2015" in Year: #perid D is in nano barns everything else is in petabarns
        ...
        d[Year][Period][" Prescale Corrected"] = df.loc["Total"][" Prescale Corrected"]/1000
    else:
        d[Year][Period][" LAr Corrected"] = df.loc["Total"][" LAr Corrected"]
        d[Year][Period][" Prescale Corrected"] = df.loc["Total"][" Prescale Corrected"]
    if "2015" in Year:
...
dfNew = pd.read_csv("/Users/agrummer/cernbox/www/bmumu2020/YeildPlots/Triggers/BphysTriggers"+"2016"+".csv", index_col=0)
...
PreScaleCorrected = list(result[" Prescale Corrected"])
...
Gain2020 = np.divide(EventNumbers2020, PreScaleCorrected)
# print("Gain2")
# print(Gain)
...
MakeATGraph.MakeTheGraph(int(16), NumOfPoints, Gain/1000, SumLumi, Error/1000, SumLumi2, Gain2020/1000)
